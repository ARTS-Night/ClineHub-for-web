...
import { G as i, H as a, K as o, U as s, a as c, d as l, k as u, rt as d, s as f, v as p, w as ee, x as m, y as h } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { t as te } from "./channel-D5F73w4K.js";
import { c as g, g as _ } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { t as ne } from "./chunk-5VM5RSS4-DAnVCoXQ.js";
import { t as re } from "./chunk-2GRJ4B5K-ttK-aqjs.js";
import { t as v } from "./chunk-XXDRQBXY-D_0KuIQA.js";
import { t as y } from "./chunk-KBJHAD2P-Dz0ldegv.js";
import { o as b } from "./chunk-QR6OTTB3-BxzOpq6Z.js";
import { i as x, n as S, r as C, t as w } from "./mermaid.core-CoIgm_7k.js";
...
var T = "flowchart-", E = class {
	...
	addVertex(e, t, r, i, a, o, s = {}, c) {
		...
		if (f === void 0 && (t === void 0 && r === void 0 && i != null && n.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), f = {
			...
			styles: [],
			classes: []
		}, this.vertices.set(e, f)), this.vertexCounter++, t === void 0 ? f.text === void 0 && (f.text = e) : (this.config = m(), d = this.sanitizeText(t.text.trim()), f.labelType = t.type, d.startsWith("\"") && d.endsWith("\"") && (d = d.substring(1, d.length - 1)), f.text = d), r !== void 0 && (f.type = r), i?.forEach((e) => {
			f.styles.push(e);
		}), a?.forEach((e) => {
			f.classes.push(e);
...
You have to call mermaid.initialize.`);
	...
	addSubGraph(e, r, i) {
		...
		}, "uniq"))(r.flat()), c = s.nodeList, l = s.dir, u = l !== void 0, d = m().flowchart ?? {}, f = l ?? (d.inheritDir ? this.getDirection() ?? m().direction ?? void 0 : void 0);
		if (this.version === "gen-1") for (let e = 0; e < c.length; e++) c[e] = this.lookUpDomId(c[e]);
		...
		return n.info("Adding", p.id, p.nodes, p.dir), p.nodes = this.makeUniq(p, this.subGraphs).nodes, this.subGraphs.push(p), this.subGraphLookup.set(a, p), a;
	}
	getPosForId(e) {
	...
	draw: /* @__PURE__ */ t(async function(e, t, r, i, a) {
		...
		let { securityLevel: o, flowchart: s, layout: c } = m();
		i.db.setDiagramId(t), n.debug("Before getData: ");
		let l = i.db.getData();
		n.debug("Data: ", l);
		let u = v(t, o), d = i.db.getDirection();
		l.type = i.type, l.layoutAlgorithm = C(c), l.layoutAlgorithm === "dagre" && c === "elk" && n.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), l.direction = d, l.nodeSpacing = s?.nodeSpacing || 50, l.rankSpacing = s?.rankSpacing || 50, l.markers = [
			"point",
			"circle",
			"cross"
		], l.diagramId = t, n.debug("REF1:", l), await x(l, u, a);
		let f = l.config.flowchart?.diagramPadding ?? 8;
		_.insertTitle(u, "flowchartTitleText", s?.titleTopMargin || 0, i.db.getDiagramTitle()), y(u, f, "flowchart", s?.useMaxWidth || !1);
	}, "draw")
}, O = (function() {
