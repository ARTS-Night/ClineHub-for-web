...
import { T as r, b as i, x as a } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { $ as o, J as s, K as c, Q as l, X as u, Y as d, Z as f, et as p, g as m, nt as h, q as g, rt as _, tt as v, u as y } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { t as b } from "./line-B4kwC9Sr.js";
import { n as x } from "./chunk-WRU74C26-2tQNDD2Y.js";
import { i as S, n as ee, r as C, t as w } from "./chunk-7BUUIJ7U-nEj9ozwq.js";
import { n as T } from "./chunk-UBXNYLIW-B89mmlsE.js";
import { i as E, n as D } from "./chunk-W5SLKNZC-Bs8d-RNY.js";
import { t as te } from "./rough.esm-BSej9Nhy.js";
import { r as O } from "./chunk-QR6OTTB3-BxzOpq6Z.js";
...
var ne = /* @__PURE__ */ e((e, t, n, r, i, a = !1, o) => {
	...
	"dependency",
	"barb"
], j = /* @__PURE__ */ e((e, n, r, i, a, o, s = !1, c) => {
	let l = k[r], u = l && A.includes(l.type);
	if (!l) {
...
}, "addEdgeMarker"), re = /* @__PURE__ */ e((e) => typeof e == "string" ? e : a()?.flowchart?.curve, "resolveEdgeCurveType"), M = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ e(() => {
	M.clear(), N.clear();
}, "clear"), F = /* @__PURE__ */ e((e) => e ? typeof e == "string" ? e : e.reduce((e, t) => e + ";" + t, "") : "", "getLabelStyles"), I = /* @__PURE__ */ e(async (e, i) => {
	...
	u.attr("transform", w(m, s)), M.set(i.id, l), i.width = p.width, i.height = p.height;
	let h;
	if (i.startLabelLeft) {
		let t = e.insert("g").attr("class", "edgeTerminals"), r = t.insert("g").attr("class", "inner"), a = await O(r, i.startLabelLeft, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).startLeft = t, L(h, i.startLabelLeft);
	}
	if (i.startLabelRight) {
		let t = e.insert("g").attr("class", "edgeTerminals"), r = t.insert("g").attr("class", "inner"), a = await O(r, i.startLabelRight, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
			let e = a.children[0], t = n(a);
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).startRight = t, L(h, i.startLabelRight);
	}
	if (i.endLabelLeft) {
		let t = e.insert("g").attr("class", "edgeTerminals"), r = t.insert("g").attr("class", "inner"), a = await O(t, i.endLabelLeft, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
			let e = a.children[0], t = n(a);
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).endLeft = t, L(h, i.endLabelLeft);
	}
	if (i.endLabelRight) {
		let t = e.insert("g").attr("class", "edgeTerminals"), r = t.insert("g").attr("class", "inner"), a = await O(t, i.endLabelRight, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
			let e = a.children[0], t = n(a);
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).endRight = t, L(h, i.endLabelRight);
	}
	return f;
}, "insertEdgeLabel");
function L(e, t) {
...
e(L, "setTerminalWidth");
var R = /* @__PURE__ */ e((e, n) => {
	t.debug("Moving label abc88 ", e.id, e.label, M.get(e.id), n);
	let r = n.updatedPath ? n.updatedPath : n.originalPath, i = a(), { subGraphTitleTotalMargin: o } = T(i);
	if (e.label) {
		let i = M.get(e.id), a = e.x, s = e.y;
		if (r) {
	...
	if (e.startLabelLeft) {
		let t = N.get(e.id).startLeft, n = e.x, i = e.y;
		if (r) {
	...
	if (e.startLabelRight) {
		let t = N.get(e.id).startRight, n = e.x, i = e.y;
		if (r) {
	...
	if (e.endLabelLeft) {
		let t = N.get(e.id).endLeft, n = e.x, i = e.y;
		if (r) {
	...
	if (e.endLabelRight) {
		let t = N.get(e.id).endRight, n = e.x, i = e.y;
		if (r) {
...
}, "positionEdgeLabel"), ie = /* @__PURE__ */ e((e, t) => {
...
}, "orthogonalizeToLabelClippedPoints"), z = /* @__PURE__ */ e((e, t) => {
	let n = e.x, r = e.y, i = Math.abs(t.x - n), a = Math.abs(t.y - r), o = e.width / 2, s = e.height / 2;
	return i >= o || a >= s;
}, "outsideNode"), B = /* @__PURE__ */ e((e, n, r) => {
...
}, "intersection"), V = /* @__PURE__ */ e((e, n) => {
	t.warn("abc88 cutPathAtIntersect", e, n);
	let r = [], i = e[0], a = !1;
	return e.forEach((e) => {
		if (t.info("abc88 checking point", e, n), !z(n, e) && !a) {
			let o = B(n, i, e);
...
e(H, "extractCornerPoints");
var U = /* @__PURE__ */ e(function(e, t, n) {
	let r = t.x - e.x, i = t.y - e.y, a = n / Math.sqrt(r * r + i * i);
	return {
		x: t.x - a * r,
		y: t.y - a * i
	};
}, "findAdjacentPoint"), ae = /* @__PURE__ */ e(function(e) {
	let { cornerPointPositions: n } = H(e), r = [];
	for (let i = 0; i < e.length; i++) if (n.includes(i)) {
		let n = e[i - 1], a = e[i + 1], o = e[i], s = U(n, o, 5), c = U(a, o, 5), l = c.x - s.x, u = c.y - s.y;
		r.push(s);
	...
	return r;
}, "fixCorners"), oe = /* @__PURE__ */ e((e, t, n) => {
	let r = e - t - n, i = Math.floor(r / 4);
	return `0 ${t} ${Array(i).fill("2 2").join(" ")} ${n}`;
}, "generateDashArray"), W = /* @__PURE__ */ e(function(e, r, i, x, C, w, T, E = !1) {
	if (!T) throw Error(`insertEdge: missing diagramId for edge "${r.id}" \u2014 edge IDs require a diagram prefix for uniqueness`);
	let { handDrawnSeed: O, layout: k } = a(), A = r.points, j = !1, M = C;
	var N = w;
	let P = [];
	for (let e in r.cssCompiledStyles) D(e) || P.push(r.cssCompiledStyles[e]);
	if (k === "swimlane") {
		if (N.intersect && M.intersect && Array.isArray(A) && A.length >= 2) {
			if (A.length === 2) A = [M.intersect(A[0]), N.intersect(A[1])];
			else {
				let e = A.slice(1, -1), t = e[0], n = e[e.length - 1], r = .5, i = Math.abs(A[A.length - 1].x - n.x) < r && Math.abs(A[A.length - 1].y - n.y) < r, a = M.intersect(t), o = i ? n : N.intersect(n), s = Math.abs(o.x - n.x) < r && Math.abs(o.y - n.y) < r, c = Math.abs(a.x - t.x) < r && Math.abs(a.y - t.y) < r ? [] : [a], l = s ? [] : [o];
				A = [
					...c,
					...e,
					...l
		...
		A = ie(r, A);
	} else N.intersect && M.intersect && !E && (A = A.slice(1, r.points.length - 1), A.unshift(M.intersect(A[0])), A.push(N.intersect(A[A.length - 1])));
	let F = btoa(JSON.stringify(A));
	r.toCluster && (t.info("to cluster abc88", i.get(r.toCluster)), A = V(r.points, i.get(r.toCluster).node), j = !0), r.fromCluster && (t.debug("from cluster abc88", i.get(r.fromCluster), JSON.stringify(A, null, 2)), A = V(A.reverse(), i.get(r.fromCluster).node).reverse(), j = !0);
	let I = A.filter((e) => !Number.isNaN(e.y)), L = re(r.curve);
	L !== "rounded" && (I = ae(I));
	let R = _;
	switch (L) {
		case "linear":
	...
	let { x: z, y: B } = ee(r), H = b().x(z).y(B).curve(R), U;
	switch (r.thickness) {
		case "normal":
	...
	let W, K = L === "rounded" ? G(q(I, r), 5) : H(I), J = Array.isArray(r.style) ? r.style : [r.style], Y = J.find((e) => e?.startsWith("stroke:")), X = "";
	...
	if (r.look === "handDrawn") {
		...
		U += " transition", W = n(i).select("path").attr("id", `${T}-${r.id}`).attr("class", " " + U + (r.classes ? " " + r.classes : "") + (X ? " " + X : "")).attr("style", J ? J.reduce((e, t) => e + ";" + t, "") : "");
		let a = W.attr("d");
		W.attr("d", a), e.node().appendChild(W.node());
	} else {
		let t = P.join(";"), n = J ? J.reduce((e, t) => e + t + ";", "") : "", i = (t ? t + ";" + n + ";" : n) + ";" + (J ? J.reduce((e, t) => e + ";" + t, "") : "");
		W = e.append("path").attr("d", K).attr("id", `${T}-${r.id}`).attr("class", " " + U + (r.classes ? " " + r.classes : "") + (X ? " " + X : "")).attr("style", i), Y = i.match(/stroke:([^;]+)/)?.[1], Z = r.animate === !0 || !!r.animation || t.includes("animation");
		let a = W.node(), o = typeof a.getTotalLength == "function" ? a.getTotalLength() : 0, s = S[r.arrowTypeStart] || 0, c = S[r.arrowTypeEnd] || 0;
		if (r.look === "neo" && !Z) {
			let e = `stroke-dasharray: ${r.pattern === "dotted" || r.pattern === "dashed" ? oe(o, s, c) : `0 ${s} ${o - s - c} ${c}`}; stroke-dashoffset: 0;`;
			W.attr("style", e + W.attr("style"));
		}
	}
	W.attr("data-edge", !0), W.attr("data-et", "edge"), W.attr("data-id", r.id), W.attr("data-points", F), W.attr("data-look", y(r.look)), r.showPoints && I.forEach((t) => {
	...
	let se = !Z && r?.look === "neo";
	ne(W, r, Q, T, x, se, Y);
	let ce = Math.floor(A.length / 2), le = A[ce];
	m.isLabelCoordinateInPath(le, W.attr("d")) || (j = !0);
	let $ = {};
...
e(q, "applyMarkerOffsetsToPoints");
var J = /* @__PURE__ */ e((e, t, n, r) => {
	t.forEach((t) => {
		Y[t](e, n, r);
	});
}, "insertMarkers"), Y = {
...
//#endregion
export { X as a, I as i, M as n, R as o, W as r, N as s, P as t };
