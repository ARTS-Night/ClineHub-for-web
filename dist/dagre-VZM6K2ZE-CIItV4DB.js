...
import { x as n } from "./chunk-I66GZJ75-DaJZKFkN.js";
...
import { n as r } from "./chunk-UBXNYLIW-B89mmlsE.js";
import { t as i } from "./graphlib-feYbMzBj.js";
import { t as a } from "./dagre-C__I8_qD.js";
import { a as o, i as s, n as c, o as l, r as u, t as d } from "./chunk-RYQCIY6F-CFH1-dB5.js";
import "./chunk-W5SLKNZC-Bs8d-RNY.js";
import { a as f, c as p, i as m, l as h, n as g, t as _, u as v } from "./chunk-QR6OTTB3-BxzOpq6Z.js";
import { a as y, i as b, o as x, r as S, t as C } from "./chunk-7Z6QIM7H-D3Vl-BKN.js";
...
var w = /* @__PURE__ */ e((e, t, n) => Math.max(t, Math.min(n, e)), "clamp"), T = /* @__PURE__ */ e((e = "TB") => {
	...
	await Promise.all(i.nodes().map(async function(e) {
		...
		if (t.info("(Insert) Node XXX" + e + ": " + JSON.stringify(i.node(e))), n?.clusterNode) {
	...
	await Promise.all(o(i).map(async function(e) {
		let n = i.node(e);
		if (t.info("Position XBX => " + e + ": (" + n.x, "," + n.y, ") width: ", n.width, " height: ", n.height), n?.clusterNode) n.y += N, t.info("A tainted cluster node XBX1", e, n.id, n.width, n.height, n.x, n.y, i.parent(e)), u.get(n.id).node = n, p(n);
			...
			let r = n?.padding / 2 || 0, a = n?.labelBBox?.height || 0, o = a - r || 0;
			t.debug("OffsetY", o, "labelHeight", a, "halfPadding", r), await m(w, n), u.get(n.id).node = n;
		} else {
			let e = i.node(n.parentId);
			n.y += N / 2, t.info("A regular node XBX1 - using the padding", n.id, "parent", n.parentId, n.width, n.height, n.x, n.y, "offsetY", n.offsetY, "parent", e, e?.offsetY, n), p(n);
		}
	}));
	let P = N / 2;
	return A(i, P, { mergeSelfLoops: k }).forEach(function({ edge: e, start: n, end: r }) {
		...
		let a = i.node(n), o = i.node(r), s = S(T, e, u, c, a, o, d);
		x(e, s);
	...
	y(o, e.markers, e.type, e.diagramId), g(), C(), _(), c(), e.nodes.forEach((e) => {
		a.setNode(e.id, { ...e }), e.parentId && a.setParent(e.id, e.parentId);
	}), t.debug("Edges:", e.edges), e.edges.forEach((e) => {
		if (e.start === e.end) {
			let t = e.start, n = t + "---" + t + "---1", r = t + "---" + t + "---2", i = a.node(t);
			a.setNode(n, {
				domId: n,
				id: n,
				parentId: i.parentId,
				...
				width: 10,
				height: 10
			}), a.setParent(n, i.parentId), a.setNode(r, {
				domId: r,
				id: r,
				parentId: i.parentId,
				labelStyle: "",
