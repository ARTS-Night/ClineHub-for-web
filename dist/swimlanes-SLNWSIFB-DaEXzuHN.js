...
import { b as n, x as r } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { g as i } from "./chunk-NSK5VX7P-pGKppjHe.js";
import "./chunk-4I5QYGJK-_sTbXS-x.js";
import "./chunk-WRU74C26-2tQNDD2Y.js";
import { r as a } from "./chunk-7BUUIJ7U-nEj9ozwq.js";
import { n as o } from "./chunk-UBXNYLIW-B89mmlsE.js";
import { t as s } from "./graphlib-feYbMzBj.js";
import { n as c } from "./chunk-RYQCIY6F-CFH1-dB5.js";
import "./chunk-W5SLKNZC-Bs8d-RNY.js";
import { a as l, c as u, i as d, n as f, t as p } from "./chunk-QR6OTTB3-BxzOpq6Z.js";
import { a as m, i as h, n as g, r as _, s as v, t as y } from "./chunk-7Z6QIM7H-D3Vl-BKN.js";
...
async function b(e, t) {
	...
	await Promise.all(t.nodes.map(async (e) => {
		if (e.isGroup) n.setNode(e.id, { ...e });
			...
			if (m) {
				...
				p.set(e.id, t), e.width = n.width, e.height = n.height;
			}
			n.setNode(e.id, { ...e });
		}
	}));
	...
	if (globalThis.mermaidCaptureSizes) {
		let { captureNodeSizes: n } = await import("./sizeCapture-X5ZJPWSS-DPLBG13Y.js");
		n(e, t);
	}
	return {
		graph: n,
...
async function ae(e, t) {
	...
	for (let r of e.edges) {
		let i = r.start ? n.get(r.start) ?? {} : {}, a = r.end ? n.get(r.end) ?? {} : {}, o = _(t.edgePaths, { ...r }, {}, e.type, i, a, e.diagramId);
		r.label && await h(t.rootGroups, r), r.label && oe(r, o);
	}
...
e(ae, "adjustLayout");
function oe(e, r) {
	let a = r?.updatedPath ?? r?.originalPath, s = n(), { subGraphTitleTotalMargin: c } = o({ flowchart: s.flowchart ?? {} });
	if (e.label) {
		let n = g.get(e.id), o = e.x, s = e.y;
		if (a) {
			let n = i.calcLabelPosition(a);
			t.debug("Moving label " + e.label + " from (", o, ",", s, ") to (", n.x, ",", n.y, ") abc88"), r && (o = n.x, s = n.y);
		}
		n.attr("transform", `translate(${o}, ${s + c / 2})`);
	}
	if (e?.startLabelLeft) {
		let t = v.get(e.id).startLeft, n = e?.x, r = e?.y;
		if (a) {
			let t = i.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, "start_left", a);
			n = t.x, r = t.y;
		}
	...
	if (e.startLabelRight) {
		...
		if (a) {
			let t = i.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, "start_right", a);
			n = t.x, r = t.y;
		}
		t.attr("transform", `translate(${n}, ${r})`);
	}
	if (e.endLabelLeft) {
		...
		if (a) {
			let t = i.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, "end_left", a);
			n = t.x, r = t.y;
		}
		t.attr("transform", `translate(${n}, ${r})`);
	}
	if (e.endLabelRight) {
		...
		if (a) {
			let t = i.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, "end_right", a);
			n = t.x, r = t.y;
		}
		t.attr("transform", `translate(${n}, ${r})`);
	}
}
e(oe, "positionEdgeLabel");
var se = "__swimlane_default__", ce = 21, le = 20;
function ue(e) {
	return Math.max(e.padding ?? le, le);
}
e(ue, "topLaneHorizontalPadding");
function de(e) {
...
e(fe, "prepareLayoutForSwimlanes");
function pe(e) {
...
function me(e) {
	...
	for (let a of e.edges) {
		...
		if (!e || !o) {
			t.warn(I, `Edge ${a.id} has missing source or target node`);
			continue;
		}
...
e(V, "isHorizontalSegment");
function H(e, t, n = L) {
	return z(e, t, n) && Math.abs(e.y - t.y) > n;
}
e(H, "isVerticalSegment");
function U(e, t, n, r) {
...
e(_e, "sameAxisSegmentOverlapLength");
function ve(e, t = L) {
	let n = [];
...
e(ye, "classifyThreeSegmentRoute");
...
e(Fe, "segmentConflictsWithAnyEdge");
...
e(qe, "clipEdgeEndpointsToNodeBoundaries");
...
e(Xe, "cornerClearanceRange");
function Ze(e, t, n) {
	let { lo: r, hi: i } = Xe(t, n);
	return Math.min(i, Math.max(r, e));
}
e(Ze, "clampToCornerClearance");
function Qe(e) {
...
e(et, "terminalSideForSegment");
function tt(e) {
	return e === "left" || e === "right";
}
e(tt, "isHorizontalSide");
...
e(rt, "clearStraightEndpointCornerAxis");
function it(e, t, n) {
	if (e.length !== 2) return e;
	let [r, i] = e;
	return B(r, i, J) ? rt(r, i, t, n, !0) ?? e : z(r, i, J) ? rt(r, i, t, n, !1) ?? e : e;
}
e(it, "clearStraightEndpointCornerConnections");
function at(e, t, n) {
	return tt(n) ? {
		x: e.x,
...
e(st, "clearEndpointCornerConnection");
function ct(e, t, n) {
...
e(ft, "prepareEdgeEndpointsForRenderer");
function pt(e) {
...
e(vt, "recomputeNestedGroupBounds");
function yt(t, n) {
...
e(yt, "mirrorAxis");
function bt(e) {
	return !(e.nodes ?? []).some((e) => !e.isGroup) || yt(e, "y");
}
e(bt, "applyBtDirectionTransform");
function xt(e, t = "LR") {
...
e(xt, "applyLrDirectionTransform");
var St = 1e-6, Ct = 8, wt = [
	0,
	Ct,
	-Ct,
...
e(Tt, "portSwapToLShape");
function Et(t, n) {
	let r = .001, { realNodeRects: i, labelNodeRects: a } = Ae(n.values());
	for (let o of t) {
		...
		let v = V(d, u, r), y = H(d, u, r), b = V(f, d, r), x = H(f, d, r);
		if (!(v && x || y && b)) continue;
		...
		if (q(O, k, i, S ? [S] : [], -2) || q(O, k, a, [], -2)) continue;
		if (C) {
			let e = n.get(C), t = e ? K(e) : void 0;
			if (t && xe(O, t, 2)) continue;
		}
		...
		let ee = /* @__PURE__ */ e((e, n) => {
			for (let i of t) {
				...
				if (!(!t || t.length < 2)) for (let i = 0; i < t.length - 1; i++) {
					let a = t[i], o = t[i + 1];
					if (!j.has(A(a, o)) && Ie(e, n, a, o, r)) return !0;
				}
			}
			return !1;
		...
		if (l - 3 >= 0) {
			...
			if (q(e, O, i, t, -2) || ee(e, O)) continue;
		}
		let te = [
			...c.slice(0, l - 2),
			O,
			...
			if (e) {
				...
				if (t > 0 && n > 0) {
					...
					for (let e = 0; e < te.length - 1; e++) {
						let s = te[e], c = te[e + 1], l = Math.hypot(c.x - s.x, c.y - s.y), u = B(s, c, r), d = z(s, c, r);
...
e(Et, "collapseShortTerminalStub");
var Y = .001, X = 8, Z = ve, Dt = /* @__PURE__ */ e((e, t) => z(e, t, Y) || B(e, t, Y), "orthogonallyAligned");
function Ot(t, n) {
	let r = /* @__PURE__ */ e((e, t) => {
		...
		if (!(/* @__PURE__ */ e(() => Math.abs(t.boundary.y - t.rect.top) < 1 || Math.abs(t.boundary.y - t.rect.bottom) < 1 ? B(i, t.boundary, Y) && i.x >= t.rect.left + 1 && i.x <= t.rect.right - 1 : Math.abs(t.boundary.x - t.rect.left) < 1 || Math.abs(t.boundary.x - t.rect.right) < 1 ? z(i, t.boundary, Y) && i.y >= t.rect.top + 1 && i.y <= t.rect.bottom - 1 : !1, "boundaryStaysOnSameFace"))()) return;
		if (t.atStart) {
			let e = r.length > 1 && R(r[1], t.railEnd, Y), n = r.slice(e ? 2 : 1), o = n[0];
			return o && !Dt(o, a) ? void 0 : [
				i,
				a,
				...n
			];
		}
		let o = r.length > 1 && R(r[r.length - 2], t.railEnd, Y), s = r.slice(0, o ? -2 : -1), c = s[s.length - 1];
		if (!(c && !Dt(c, a))) return [
			...s,
			a,
			i
...
e(Ot, "separateSharedRenderedTerminalLanes");
function kt(t, n) {
	let { realNodeRects: r, labelNodeRects: i } = Ae(n.values()), a = /* @__PURE__ */ e((e, n) => {
		let a = e.start, o = e.end, s = Z(n);
		if (s.length !== n.length - 1) return !1;
		let c = [a, o].filter((e) => !!e);
		for (let e of s) if (q(e.a, e.b, r, c, -2) || q(e.a, e.b, i, [], -2)) return !1;
		for (let n of t) {
			if (n === e || n.isLayoutOnly) continue;
			let t = n.points;
			if (!(!t || t.length < 2)) {
				for (let e of s) for (let n of Z(G(t))) if (_e(e, n, .5) >= X || Ie(e.a, e.b, n.a, n.b, Y)) return !1;
			}
		}
		return !0;
...
e(kt, "collapseRedundantRectangularDoglegs");
function At(t, n) {
	let { realNodeRects: r, labelNodeRects: i } = Ae(n.values()), a = t.filter((e) => !e.isLayoutOnly), o = /* @__PURE__ */ e((e, t, n) => G(e === t ? n ?? [] : e.points ?? []), "pointsFor"), s = /* @__PURE__ */ e((e, t) => {
		let n = 0;
		for (let r = 0; r < a.length; r++) {
			let i = Z(o(a[r], e, t));
			for (let s = r + 1; s < a.length; s++) {
				let r = Z(o(a[s], e, t));
				for (let e of i) for (let t of r) Ie(e.a, e.b, t.a, t.b, Y) && n++;
			}
		}
		return n;
		...
		return r.filter((e) => {
			...
			let r = e.rect;
			return t.horizontal ? U(t.a.x, t.b.x, r.left, r.right) >= X && t.a.y >= r.top - 2 && t.a.y <= r.bottom + 2 : U(t.a.y, t.b.y, r.top, r.bottom) >= X && t.a.x >= r.left - 2 && t.a.x <= r.right + 2;
		});
		...
		for (let e of l) if (q(e.a, e.b, r, c, -2) || q(e.a, e.b, i, [], -2)) return !1;
		for (let t of a) if (t !== e) {
			for (let e of l) for (let n of Z(o(t))) if (_e(e, n, .5) >= X) return !1;
		}
		return s(e, t) <= n;
	}, "candidateIsSafe");
	for (let e = 0; e < 8; e++) {
...
e(At, "liftObstacleHuggingSameSideRails");
function jt(t, n) {
	let r = /* @__PURE__ */ e((e) => {
	...
	for (let e of t) {
		...
		let t = G(e.points ?? []);
		for (let e of Z(t)) for (let t of o) a(e, t.rect) && (s = Math.max(s, t.rect.bottom - e.a.y + 4));
	}
	if (!(s <= Y)) for (let e of o) {
...
e(jt, "liftTopLaneTitleBandsAboveRails");
function Mt(t, n) {
	let r = /* @__PURE__ */ e((e) => {
		let t = e.groupTitleRect;
		if (!(!t || typeof t.left != "number" || typeof t.right != "number" || typeof t.top != "number" || typeof t.bottom != "number" || !Number.isFinite(t.left) || !Number.isFinite(t.right) || !Number.isFinite(t.top) || !Number.isFinite(t.bottom) || t.right <= t.left || t.bottom <= t.top)) return {
	...
	for (let e of t) {
		if (e.isLayoutOnly) continue;
		let t = G(e.points ?? []);
		for (let e of Z(t)) for (let t of s) if (a(e, t.rect)) c = Math.max(c, t.rect.right - e.a.x + 4);
		else if (o(e, t.rect)) {
			let n = Math.min(e.a.x, e.b.x);
			c = Math.max(c, t.rect.right - n + 4);
		}
	}
	if (!(c <= Y)) for (let e of s) {
...
e(Mt, "shiftLeftLaneTitleBandsLeftOfRails");
function Nt(t, n) {
	let { realNodeRects: r } = Ae(n.values()), i = t.filter((e) => !e.isLayoutOnly), a = /* @__PURE__ */ e((e, t = /* @__PURE__ */ new Map()) => G(t.get(e) ?? e.points ?? []), "replacementPointsFor"), o = /* @__PURE__ */ e((e = /* @__PURE__ */ new Map()) => {
		let t = 0;
		...
		return t;
	}, "crossingCount"), s = /* @__PURE__ */ e((e = /* @__PURE__ */ new Map()) => i.reduce((t, n) => t + W(a(n, e)), 0), "totalBends"), c = /* @__PURE__ */ e((e) => {
		let t = a(e);
		...
		let n = [e.start, e.end].filter((e) => !!e);
		for (let e of Z(t)) if (q(e.a, e.b, r, n, -2)) return !0;
		return !1;
	}, "pathHasNodeHit"), d = /* @__PURE__ */ e((e, t, n) => {
		for (let r of i) if (r !== e) {
			for (let e of Z(t)) for (let t of Z(a(r, n))) if (_e(e, t, .5) >= X) return !0;
		}
		return !1;
...
e(Nt, "swapDestinationTerminalTailsToReduceCrossings");
function Pt(t, n) {
	let { realNodeRects: r, labelNodeRects: i } = Ae(n.values()), a = t.filter((e) => !e.isLayoutOnly), o = /* @__PURE__ */ e((e, t = /* @__PURE__ */ new Map()) => G(t.get(e) ?? e.points ?? []), "replacementPointsFor"), s = /* @__PURE__ */ e((e = /* @__PURE__ */ new Map()) => {
		let t = 0;
		...
		return t;
	}, "strictCrossingCount"), c = /* @__PURE__ */ e((e = /* @__PURE__ */ new Map()) => a.reduce((t, n) => t + W(o(n, e)), 0), "totalBends"), l = /* @__PURE__ */ e((e) => {
		...
		return e;
	}, "collectExternalRails"), f = /* @__PURE__ */ e((e, t) => e.edge !== t.edge && e.axis === t.axis && e.side === t.side && U(e.min, e.max, t.min, t.max) >= X, "railsInteract"), p = /* @__PURE__ */ e((e) => {
		...
		if (t.length <= 6) {
			let a = Array(r.length).fill(!1), o = [], s = /* @__PURE__ */ e(() => {
				if (o.length === t.length) {
					o.some((e, t) => Math.abs(e - n[t]) >= Y) && i.push([...o]);
					return;
				}
		...
		for (let [t, n] of e) {
			...
			for (let t of Z(n)) if (q(t.a, t.b, r, e, -2) || q(t.a, t.b, i, [], -2)) return !1;
		}
		for (let t = 0; t < a.length; t++) {
			let n = a[t], r = e.has(n), i = Z(o(n, e));
			for (let n = t + 1; n < a.length; n++) {
				let t = a[n];
				if (!r && !e.has(t)) continue;
				let s = Z(o(t, e));
				for (let e of i) for (let t of s) if (_e(e, t, .5) >= X) return !1;
			}
		}
		return !0;
	}, "candidateIsSafe");
...
e(Pt, "reassignCrossingExternalRailChannels");
function Ft(t, n) {
	let { realNodeRects: r, labelNodeRects: i } = Ae(n.values()), a = t.filter((e) => !e.isLayoutOnly), o = /* @__PURE__ */ e((e, t, n) => G(e === t ? n ?? [] : e.points ?? []), "pointsFor"), s = /* @__PURE__ */ e((e) => Z(e).reduce((e, t) => {
		...
		for (let e of Z(t)) if (q(e.a, e.b, r, s, -2) || q(e.a, e.b, i, [], -2) || d.some((t) => l(e, t))) return !1;
		for (let n of a) if (n !== e) {
			for (let e of Z(t)) for (let t of Z(o(n))) if (_e(e, t, .5) >= X) return !1;
		}
		return c(e, t) <= n;
	}, "candidateIsSafe");
	for (let e = 0; e < 8; e++) {
		...
		for (let u of a) {
			let a = o(u), p = W(a, Y), m = s(a);
			for (let o = 0; o <= a.length - 4; o++) for (let h of d(a, o)) {
				let a = W(h, Y), o = s(h);
				if (!(a < p || a === p && o < m - Y) || !f(u, h, e)) continue;
				let d = c(u, h);
...
e(Ft, "shortcutRedundantOrthogonalJogs");
function It(t, n) {
	let r = [];
	...
	let i = new Map(r.map((e) => [e.id, e])), a = r.map((e) => ({
		...
		return n;
	}, "outwardTracksForSide"), d = /* @__PURE__ */ e((e, t = /* @__PURE__ */ new Map()) => G(t.get(e) ?? e.points ?? []), "replacementPointsFor"), f = /* @__PURE__ */ e((e, t) => {
		let n = 0;
		for (let r of e) for (let e of t) Ie(r.a, r.b, e.a, e.b, Y) && n++;
		return n;
	}, "crossingCountBetweenSegments"), p = /* @__PURE__ */ e((e, t) => f(Z(e), Z(t)), "crossingCountBetweenPaths"), m = /* @__PURE__ */ e((t = /* @__PURE__ */ new Map()) => {
	...
	}, 0), "pathLength"), S = /* @__PURE__ */ e((e = /* @__PURE__ */ new Map()) => c.reduce((t, n) => t + W(d(n, e)), 0), "totalBends"), C = /* @__PURE__ */ e((e = /* @__PURE__ */ new Map()) => c.reduce((t, n) => t + x(d(n, e)), 0), "totalLength"), w = /* @__PURE__ */ e((e, t, n = /* @__PURE__ */ new Map()) => {
		let r = Z(t);
		...
		let n = [e.start, e.end].filter((e) => !!e);
		for (let e of Z(t)) if (q(e.a, e.b, a, n, -2)) return !0;
		return !1;
		...
		for (let s of o) {
			let o = Ee(r, s), c = s === "top" || s === "bottom" ? u(s) : a;
			for (let r of i) {
				E(e, [
					t,
					n,
	...
	}, "addVerticalDepartureOuterTrackCandidates"), re = /* @__PURE__ */ e((e, t, n, r) => {
		let i = [...u("left"), ...u("right")], a = [...u("top"), ...u("bottom")];
		for (let s of o) {
			let o = Ee(r, s), c = s === "left" || s === "right" ? u(s) : i;
			for (let r of a) {
				E(e, [
					t,
					n,
	...
	}, "addHorizontalDepartureOuterTrackCandidates"), P = /* @__PURE__ */ e((e) => {
		let t = e.start, n = e.end, r = n ? i.get(n) : void 0;
		if (!t || !r) return [];
		let a = G(e.points ?? []);
		if (a.length < 4) return [];
		let o = a[0], s = a[1], c = [];
		return H(o, s, Y) ? N(c, o, s, r) : V(o, s, Y) && re(c, o, s, r), c;
	}, "terminalPreservingOuterTrackCandidates"), ie = /* @__PURE__ */ e((e) => {
		let t = e.start, n = e.end, r = t ? i.get(t) : void 0, a = n ? i.get(n) : void 0;
		if (!r || !a) return [];
		let s = [];
		for (let e of o) {
			let t = Ee(r, e);
			for (let n of o) s.push(...ne(t, e, Ee(a, n), n));
		}
		return s.push(...P(e)), s;
	}, "candidatePathsFor"), ae = /* @__PURE__ */ e(() => new Map(c.map((e) => [e, Z(d(e))])), "currentSegmentsByEdge"), oe = /* @__PURE__ */ e((e, t, n) => {
		...
		return r;
	}, "sharedTrackConflictsFor"), se = /* @__PURE__ */ e((e, t, n, r) => {
	...
	}, "pairCandidatesFor"), ce = /* @__PURE__ */ e((e, t, n, r, i, a) => {
		let o = 0;
		...
		return e.count - o + s;
	}, "pairCrossingCount"), le = /* @__PURE__ */ e((e, t) => {
		for (let n of e.sharedTrackConflicts) if (n !== t) return !1;
		return !0;
	}, "conflictsOnlyWith"), ue = /* @__PURE__ */ e((e, t) => e.segments.some((e) => t.segments.some((t) => _e(e, t, .5) >= X)), "candidatesShareTrack"), de = /* @__PURE__ */ e((e, t, n, r) => le(t, n.edge) && le(r, e.edge) && !ue(t, r), "pairCandidatesAreCompatible"), fe = /* @__PURE__ */ e((e, t, n, r, i) => {
	...
	}, "scorePairReplacement"), pe = /* @__PURE__ */ e((e, t) => e.crossings < t.crossings || e.crossings === t.crossings && (e.bends < t.bends || e.bends === t.bends && e.length < t.length), "pairScoreIsBetter"), F = /* @__PURE__ */ e((e, t, n, r) => {
		let i = r;
		...
		return i;
	}, "bestScoreForOptionPair"), I = /* @__PURE__ */ e((e) => {
...
e(It, "resolveRenderedOrthogonalCrossings");
var Lt = .001, Rt = 8;
function zt(t, n) {
	let { nodeInfoById: r, realNodeRects: i } = ke(n), a = [
		"top",
		"bottom",
		"left",
		"right"
		...
		let i = [], a = De(e, t, n, r, 20, Lt);
		return a && i.push(a), t === r && i.push(Oe(e, t, n, o[t])), i;
	}, "buildOrthogonalPathCandidates"), c = /* @__PURE__ */ e((e, t) => {
		for (let n = 0; n < e.length - 1; n++) {
			let r = e[n], a = e[n + 1];
			if (q(r, a, i, t, 1)) return !0;
		}
		return !1;
	}, "pathHitsNode"), l = /* @__PURE__ */ e((e, n, r = !1) => {
		let i = 0, a = ve(e, Lt), o = n.start, s = n.end;
		for (let e of t) {
...
function Gt(t, n) {
	...
	let o = /* @__PURE__ */ e((e, t) => {
		let n = we(t, 3);
		for (let { nodeId: t, rect: r } of i) if (t !== e && Ce(n, r)) return !0;
		return !1;
	}, "labelOverlapsForeignNode"), s = /* @__PURE__ */ e((e, t) => {
		let n = we(t, 3);
		for (let t of r) if (t.edgeId !== e && be(t.p1, t.p2, n)) return !0;
		return !1;
	}, "labelOverlapsForeignEdge"), c = /* @__PURE__ */ e((e, t, n) => o(e, n) || s(t, n), "labelOverlapsAnything"), l = [], u = /* @__PURE__ */ e((e) => {
		for (let { id: t, rect: n } of a) if (Se(n, e)) return t;
	}, "findContainingLane"), d = /* @__PURE__ */ e((e, t) => l.some((n) => n.labelId !== e && Ce(t, n.rect)), "overlapsPlacedLabel");
	for (let r of t) {
		...
		let g = h.length >= 3 ? h.filter((e) => e.idx > 0 && e.idx < h.length - 1) : h, _ = g.length > 0 ? g : h, v = p >= m ? "horizontal" : "vertical", y = /* @__PURE__ */ e((e) => [...e].sort((e, t) => {
		...
		}, "anchorAtT"), w = /* @__PURE__ */ e((e, t, n) => Math.min(n, Math.max(t, e)), "clamp"), T = /* @__PURE__ */ e((e, t) => e.midX >= t.left - Q && e.midX <= t.right + Q && e.midY >= t.top - Q && e.midY <= t.bottom + Q, "pointInsideRectInclusive"), E = /* @__PURE__ */ e((e) => {
			...
			for (let e of n) for (let n of S) {
				...
				if (!O(e, i)) continue;
				let a = E(i);
				if (a && !Wt(a.rect, f) && !d(t, a.rect) && !c(t, r.id, a.rect)) return {
					laneId: a.laneId,
					anchor: a.anchor
				};
			}
			...
			for (let e of a) {
				...
				if (n && !O(e, a)) continue;
				let c = E(a);
				if (c && !Wt(c.rect, f) && !d(t, c.rect) && !o(t, c.rect) && (i || !s(r.id, c.rect))) return {
					laneId: c.laneId,
					anchor: c.anchor
				};
			}
		...
		if (j) {
			...
			let e = Te(j.anchor.midX, j.anchor.midY, p, m), n = l.findIndex((e) => e.labelId === t);
			n >= 0 ? l[n] = {
				labelId: t,
				rect: e
			} : l.push({
...
var Kt = 1e-6, qt = 4, Jt = 3;
function Yt(e, t) {
	return e < t ? `${e}::${t}` : `${t}::${e}`;
}
e(Yt, "pairKey");
function Xt(t, n) {
	let { nodeInfoById: r, realNodeRects: i } = ke(n), a = /* @__PURE__ */ new Map();
	for (let e of n) {
		let t = e.id;
	...
	for (let e of t) {
		...
		if (q(p, m, i, [s, c], 1)) continue;
		let h = o(e, s, c, d ? "x" : "y"), g = h > qt ? h : qt, _ = [
			0,
			g,
			-g
		];
		for (let n of _) {
			...
			if (!q(r, a, i, [s, c], 1) && !Fe(r, a, t, e, { epsilon: Kt })) {
				e.points = [r, a];
				break;
			}
		}
...
function Zt(t, n) {
	let r = .001, { realNodeRects: i, labelNodeRects: a } = Ae(n.values()), o = /* @__PURE__ */ e((e, t) => ve(t, r).map((n) => ({
		...n,
		edge: e,
		...
		for (let n of t) {
			if (n.isLayoutOnly) continue;
			let t = n.points;
			!t || t.length < 2 || e.push(...o(n, G(t)));
		}
		return e;
	}, "allSegments"), c = /* @__PURE__ */ e((e, t) => e.horizontal && t.horizontal ? U(e.a.x, e.b.x, t.a.x, t.b.x) >= 8 && Math.abs(e.a.y - t.a.y) < 7 : e.vertical && t.vertical ? U(e.a.y, e.b.y, t.a.y, t.b.y) >= 8 && Math.abs(e.a.x - t.a.x) < 7 : !1, "hasCrowdedParallelTrack"), l = /* @__PURE__ */ e((e, n) => {
		let s = e.start, l = e.end, u = o(e, n);
		if (u.length !== n.length - 1) return !1;
		let d = [s, l].filter((e) => !!e), f = e.labelNodeId ? [e.labelNodeId] : [];
		for (let e of u) if (q(e.a, e.b, i, d, -2) || q(e.a, e.b, a, f, -2)) return !1;
		for (let n of t) {
			if (n === e || n.isLayoutOnly) continue;
			let t = n.points;
			if (!(!t || t.length < 2)) {
				for (let e of u) for (let i of o(n, G(t))) if (c(e, i) || Ie(e.a, e.b, i.a, i.b, r)) return !1;
			}
		}
		return !0;
...
function en(t, n) {
	...
	if ((n === "LR" || n === "RL") && a.length > 0 && !xt(t, n) || n === "BT" && a.length > 0 && !bt(t)) return;
	for (let e of i) {
		if (e.isLayoutOnly) continue;
		let t = e.points;
		!t || t.length < 2 || (e.points = Ve(Be(t)));
	}
	zt(i, r), Xt(i, r), Tt(i, r);
	let o = /* @__PURE__ */ new Map();
	for (let e of r) o.set(String(e.id), e);
	Gt(i, o), qe(i, o), Et(i, o), Zt(i, o), Ot(i, o), kt(i, o), At(i, o), Nt(i, o);
	let s = /* @__PURE__ */ e(() => {
		It(i, o), Pt(i, o), Ft(i, o), Gt(i, o), ft(i, o), At(i, o), Gt(i, o), ft(i, o);
	}, "finalizeRenderedEdges");
	s(), Zt(i, o), s(), jt(i, o), Mt(i, o), jt(i, o), Mt(i, o);
}
...
function xn(t, n) {
	let r = tn(t), i = n?.laneOf ?? (() => null), a = n?.rankHint, { preds: o } = cn(r);
	for (let e of o.values()) e.sort((e, t) => e.localeCompare(t));
	let s = un(r) ?? [...r.nodes].sort((e, t) => e.localeCompare(t)), c = /* @__PURE__ */ new Map();
...
function Tn(t) {
	let n = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), i = [], a = [], o = 0, s = /* @__PURE__ */ e((e, c) => {
		n.set(e, ++o), r.set(e, o);
		for (let l of t.get(e) ?? []) l !== c && (n.has(l) ? (n.get(l) ?? 0) < (n.get(e) ?? 0) && (i.push([e, l]), r.set(e, Math.min(r.get(e) ?? o, n.get(l) ?? o))) : (i.push([e, l]), s(l, e), r.set(e, Math.min(r.get(e) ?? o, r.get(l) ?? o)), (r.get(l) ?? 0) >= (n.get(e) ?? 0) && a.push(En(e, l, i, a.length))));
	}, "visit");
...
function zn(t, n) {
	...
	}).rankOf }, a = hn(r), { preds: o, succs: s } = cn(r, (e) => {
		if (n?.ignoreCrossLaneEdges) {
			let t = a(e.src), n = a(e.dst);
			if (t && n && t !== n) return !1;
		}
		return !0;
	}), c = un(r) ?? [...r.nodes], l = [...c].reverse(), u = /* @__PURE__ */ e((e, t) => {
		let n = 0;
	...
	}, "clampFeasible"), d = yn.GRAVITY_ITERATIONS, f = /* @__PURE__ */ e((e) => {
		let t = !1;
		for (let n of e) {
...
function Vn(t, n) {
	let r = tn(t), i = n?.direction === "LR" ? Bn(r) ?? [...r.nodes].sort() : un(r) ?? [...r.nodes].sort(), a = hn(r), o = /* @__PURE__ */ e((e) => a(e) ?? e, "laneOf"), s = /* @__PURE__ */ Object.create(null), c = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ e((e, t) => n?.ignoreCrossLaneEdges ?? !0 ? +(o(e) === o(t)) : 1, "edgeWeight");
	for (let e of i) {
...
e(Zn, "orderLayers");
function Qn(t, n, r) {
	let i = r?.layerGap ?? bn.DEFAULT_LAYER_GAP, a = r?.nodeGap ?? bn.DEFAULT_NODE_GAP, o = r?.laneGap ?? a * 2, s = r?.direction ?? "TB", c = s === "LR" || s === "RL", l = t.layers, u = /* @__PURE__ */ Object.create(null), d = /* @__PURE__ */ Object.create(null), f = /* @__PURE__ */ e((e) => n.nodeById.get(e), "getNode"), p = /* @__PURE__ */ e((e) => f(e)?.width ?? 0, "getWidth"), m = /* @__PURE__ */ e((e) => f(e)?.height ?? 0, "getHeight"), h = hn(n), g = _n(n, r?.laneOrder), _ = l.map((e) => e.reduce((e, t) => Math.max(e, m(t)), 0)), v = [];
...
function br(t, n) {
	...
	}, "portForSide"), m = /* @__PURE__ */ e((e, t, n) => p(e, _r(e, t, n ? "bottom" : "top")), "getOrthogonalPort"), h = [], g = [], _ = /* @__PURE__ */ new Set(), v = 1e3, y = /* @__PURE__ */ e((e, t, n) => {
	...
	let w = /* @__PURE__ */ e((e, t) => _r(e, t, "bottom"), "determineSide"), T = /* @__PURE__ */ new Map();
	...
	let M = /* @__PURE__ */ e((e) => !!a[e]?.labelNodeId, "edgeHasLabelNode"), ne = /* @__PURE__ */ e((e, t) => e ? (S.get(`${e}:${t}:src`) ?? []).some(({ edgeIdx: e }) => M(e)) || (S.get(`${e}:${t}:dst`) ?? []).some(({ edgeIdx: e }) => M(e)) : !1, "faceHasLabelNode"), N = /* @__PURE__ */ e((e, t, n) => t === "top" || t === "bottom" ? {
		...
		x: e.x,
		y: e.y + n
	}, "applyPortOffset"), re = /* @__PURE__ */ e((e, t, n) => {
		let r = T.get(e), i = {
			x: n.x ?? 0,
			y: n.y ?? 0
		}, a = {
	...
	for (let t of b) {
		...
		if (!r || !i) continue;
		let { pSrcPort: s, pDstPort: u, srcSide: p, dstSide: m } = re(t, r, i), v = { ...s }, b = { ...u }, w = p === "top" || p === "bottom", T = m === "top" || m === "bottom";
		w ? v.y = s.y > (r.y ?? 0) ? s.y + hr : s.y - hr : v.x = s.x > (r.x ?? 0) ? s.x + hr : s.x - hr, T ? b.y = u.y > (i.y ?? 0) ? u.y + hr : u.y - hr : b.x = u.x > (i.x ?? 0) ? u.x + hr : u.x - hr;
		...
		if (A.inside && A.obstacle) {
			...
			if (w) {
				let t = D(s, r, i, e, !0);
				v.x = t.x, v.y = t.y;
				let n = t.leavesPositiveSide ? Math.min(e.minY - 2, s.y + hr) : Math.max(e.maxY + 2, s.y - hr);
				O = [
					{
						x: s.x,
						y: n
				...
				let t = D(s, r, i, e, !1), n = t.leavesPositiveSide ? Math.min(e.minX - 2, s.x + hr) : Math.max(e.maxX + 2, s.x - hr);
				v.x = t.x, v.y = t.y, O = [
					{
						x: n,
						y: s.y
		...
		if (O.length === 0 && j.length === 0) {
			let e = fr, r = Math.abs(v.x - b.x) < e, i = Math.abs(v.y - b.y) < e, a = te.get(`${t}:src`) !== void 0 || te.get(`${t}:dst`) !== void 0, o = (S.get(`${n.start ?? ""}:${p}:src`)?.length ?? 0) + (S.get(`${n.start ?? ""}:${p}:dst`)?.length ?? 0), c = (S.get(`${n.end ?? ""}:${m}:src`)?.length ?? 0) + (S.get(`${n.end ?? ""}:${m}:dst`)?.length ?? 0), l = o > 1 || c > 1, d = C.get(n.start ?? "") ?? 0, f = C.get(n.end ?? "") ?? 0, g = o > 1 && ne(n.start, p) || c > 1 && ne(n.end, m);
		...
		let ae = c.filter((e) => e.orientation === "horizontal" && e.coord >= P && e.coord <= ie), oe = c.filter((e) => e.orientation === "vertical" && e.coord >= M && e.coord <= N), se = /* @__PURE__ */ e((e, t) => `${e.toFixed(1)},${t.toFixed(1)}`, "getKey"), ce = se(v.x, v.y), le = se(b.x, b.y), ue = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), fe = /* @__PURE__ */ new Map(), pe = /* @__PURE__ */ new Set(), F = [];
		ue.set(ce, 0), fe.set(ce, "n"), F.push({
			key: ce,
			f: Math.hypot(b.x - v.x, b.y - v.y),
			pt: v
		}), pe.add(ce);
		let I = [], me = /* @__PURE__ */ e((e, t) => x(e, t, n.start, n.end), "checkSegmentBlocked"), L = {
			x: b.x,
			y: v.y
		...
		if (R ? B || V || (I = Math.abs(v.x - b.x) < $ ? [v, b] : [
			...
			let r = e.pt.x, i = e.pt.y, a = oe.sort((e, t) => e.coord - t.coord), o = a.findIndex((e) => Math.abs(e.coord - r) < 1), s = ae.sort((e, t) => e.coord - t.coord), c = s.findIndex((e) => Math.abs(e.coord - i) < 1), l = [];
			o > 0 && l.push({
				x: a[o - 1].coord,
				y: i
			...
			for (let a of l) {
				...
				let u = se(a.x, a.y), f = Math.abs(a.x - r) + Math.abs(a.y - i), p = y(t, e.pt, a), m = 0, h = b.x - v.x, g = b.y - v.y, _ = a.x - r, x = a.y - i;
				(g > 10 && x < -5 || g < -10 && x > 5) && (m = Math.abs(x) * 100), (h > 10 && _ < -5 || h < -10 && _ > 5) && (m += Math.abs(_) * 50);
				let S = 0, C = fe.get(e.key) ?? "n", w = Math.abs(_) > $ ? "h" : "v";
				C !== "n" && C !== w && (S = 50);
				let T = f + p + m + S, E = (ue.get(e.key) ?? Infinity) + T, D = Math.abs(b.x - a.x) + Math.abs(b.y - a.y);
				if (E < (ue.get(u) ?? Infinity)) {
					if (de.set(u, e.pt), ue.set(u, E), fe.set(u, w), !pe.has(u)) F.push({
						key: u,
						f: E + D,
						pt: a
					}), pe.add(u);
		...
		if (I.length === 0 && (I = [
			...
			let t = I[0], n = I[I.length - 1], r = Math.min(t.x, n.x), i = Math.max(t.x, n.x), a = Math.min(t.y, n.y), o = Math.max(t.y, n.y);
			for (let e of I) r = Math.min(r, e.x), i = Math.max(i, e.x), a = Math.min(a, e.y), o = Math.max(o, e.y);
			...
			let u = /* @__PURE__ */ e((e) => {
				...
				let r = u(e), i = {
					...
					x: n.x,
					y: r
				}, s = me(t, i), c = me(i, a), l = me(a, o), d = r !== n.y && me(o, n);
		...
		for (let e = 0; e < U.length - 1; e++) {
			let n = U[e], r = U[e + 1], i = Math.abs(n.x - r.x) < $ ? "vertical" : "horizontal", a = i === "vertical" ? n.x : n.y, o = i === "vertical" ? Math.min(n.y, r.y) : Math.min(n.x, r.x), s = i === "vertical" ? Math.max(n.y, r.y) : Math.max(n.x, r.x), c = f(i, a, o, s), l = {
				edgeIndex: t,
				segmentIndex: e,
				orientation: i,
				pipe: c,
	...
	let P = /* @__PURE__ */ e((e, t) => e.from < t.to && t.from < e.to, "segmentsOverlap"), ie = /* @__PURE__ */ e((e, t, n, r) => {
	...
	}, "trySwapSegmentsAcrossTracks"), ae = /* @__PURE__ */ e((e) => {
	...
	}, "createNewTrack"), oe = /* @__PURE__ */ e((e, t) => {
	...
	}, "moveSegmentToTrack"), se = /* @__PURE__ */ e((e, t) => {
		let n = g[e.edgeIndex];
		for (let r of n) {
			let n = h[r];
			n.pipe === e.pipe && oe(n, t);
		}
	}, "moveSegmentChainToTrack"), ce = /* @__PURE__ */ e((e) => {
		let t = g[e.edgeIndex], n = t.indexOf(h.indexOf(e)), r = [];
		return n > 0 && r.push(h[t[n - 1]]), n < t.length - 1 && r.push(h[t[n + 1]]), r;
	}, "getAdjacentSegmentsAlongEdge"), le = /* @__PURE__ */ e((e, t) => {
		...
		return t;
	}, "resolveHandleConflicts"), F = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ e((e) => {
		...
		return t;
	}, "fixSourceHandleCrossings"), L = /* @__PURE__ */ e(() => {
		let t = 0, n = /* @__PURE__ */ new Map();
		...
		return t;
	}, "fixTargetHandleCrossings"), he = /* @__PURE__ */ e(() => {
		let e = 0;
		for (let t of c) {
			let n = [];
		...
		for (let n of r) {
			...
			let c = /* @__PURE__ */ e((e, r) => {
				n.filter((t) => t.trackIndex === e).forEach((e) => {
					...
					R.set(`${e.edgeIndex}-${e.segmentIndex}`, n);
				});
			}, "assignCoord"), l = 0;
	...
	for (let [e, t] of a.entries()) {
		...
		let r = [], { pSrcPort: i, pDstPort: a } = re(e, o.get(t.start), o.get(t.end)), s = n.map((e) => {
		...
		for (let e = 0; e < s.length; e++) {
			...
			if (Math.abs(a - t.coord) > $ && r.push(yr(t, i)), c && o.orient === t.orient) {
...
async function Cr(e, t) {
	let n = t.select("g");
	m(n, e.markers, e.type, e.diagramId), f(), y(), p(), c(), fe(e);
	let r = me(e);
