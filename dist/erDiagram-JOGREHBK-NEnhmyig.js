import { n as e, t } from "./chunk-Y2CYZVJY-CmNPyWGC.js";
import { m as n, p as r } from "./src-BfmkUsMs.js";
import { H as i, K as a, U as o, a as s, rt as c, v as l, w as u, x as d, y as f } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { t as p } from "./channel-D5F73w4K.js";
import { c as m, g as h } from "./chunk-NSK5VX7P-pGKppjHe.js";
...
import { t as g } from "./chunk-XXDRQBXY-D_0KuIQA.js";
import { t as _ } from "./chunk-KBJHAD2P-Dz0ldegv.js";
import "./chunk-W5SLKNZC-Bs8d-RNY.js";
import "./chunk-QR6OTTB3-BxzOpq6Z.js";
import "./chunk-7Z6QIM7H-D3Vl-BKN.js";
import { i as v, r as y } from "./mermaid.core-CoIgm_7k.js";
		...
		performAction: /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
			...
			switch (i) {
				...
				case 78:
					...
					break;
				case 79: this.$ = r.Identification.IDENTIFYING;
			}
		}, "anonymous"),
		table: [
			{
...
t(C, { draw: () => w });
var w = /* @__PURE__ */ e(async function(e, t, i, a) {
	n.info("REF0:"), n.info("Drawing er diagram (unified)", t);
	let { securityLevel: o, er: s, layout: c } = d(), l = a.db.getData(), u = g(t, o);
	l.type = a.type, l.layoutAlgorithm = y(c), l.config.flowchart.nodeSpacing = s?.nodeSpacing || 140, l.config.flowchart.rankSpacing = s?.rankSpacing || 80, l.direction = a.db.getDirection();
	let { config: f } = l, { look: p } = f;
	l.markers = p === "neo" ? [
		"only_one_neo",
		"zero_or_one_neo",
		"one_or_more_neo",
		...
		"one_or_more",
		"zero_or_more"
	], l.diagramId = t, await v(l, u), l.layoutAlgorithm === "elk" && u.select(".edges").lower();
	...
	}), h.insertTitle(u, "erDiagramTitleText", s?.titleTopMargin ?? 25, a.db.getDiagramTitle()), _(u, 8, "erDiagram", s?.useMaxWidth ?? !0);
}, "draw"), T = /* @__PURE__ */ e((e, t) => {
	let n = p, r = n(e, "r"), i = n(e, "g"), a = n(e, "b");
	return c(r, i, a, t);
}, "fade"), E = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), D = /* @__PURE__ */ e((e) => {
