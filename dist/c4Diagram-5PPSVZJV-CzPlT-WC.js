...
import { H as r, U as i, c as a, r as o, s, v as l, x as u, y as d, z as f } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { t as p } from "./dist-CQncfa7Z.js";
import { _ as m, n as h, r as g } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { a as _, s as v } from "./chunk-2GRJ4B5K-ttK-aqjs.js";
...
var x = b, S = [], C = [""], w = "global", T = "", E = [{
	...
	l.wrap = J(), l.typeC4Shape = { text: e }, l.parentBoundary = w;
}, "addComponent"), z = /* @__PURE__ */ e(function(e, t, n, r, i) {
...
}, "addPersonOrSystemBoundary"), B = /* @__PURE__ */ e(function(e, t, n, r, i) {
	if (e === null || t === null) return;
	let a = {}, o = E.find((t) => t.alias === e);
	...
	a.parentBoundary = w, a.wrap = J(), T = w, w = e, C.push(T);
}, "addContainerBoundary"), V = /* @__PURE__ */ e(function(e, t, n, r, i, a, o, s) {
	if (t === null || n === null) return;
...
}, "addDeploymentNode"), H = /* @__PURE__ */ e(function() {
	...
	switch (t.typeC4Shape.text) {
		...
		case "external_component_queue": s.append("path").attr("fill", r).attr("stroke-width", "0.5").attr("stroke", i).attr("d", "Mstartx,startylwidth,0c5,0 5,half 5,halfc0,0 0,half -5,halfl-width,0c-5,0 -5,-half -5,-halfc0,0 0,-half 5,-half".replaceAll("startx", t.x).replaceAll("starty", t.y).replaceAll("width", t.width).replaceAll("half", t.height / 2)), s.append("path").attr("fill", "none").attr("stroke-width", "0.5").attr("stroke", i).attr("d", "Mstartx,startyc-5,0 -5,half -5,halfc0,half 5,half 5,half".replaceAll("startx", t.x + t.width).replaceAll("starty", t.y).replaceAll("half", t.height / 2));
	}
	...
	switch (s.append("text").attr("fill", a).attr("font-family", u.fontFamily).attr("font-size", u.fontSize - 2).attr("font-style", "italic").attr("lengthAdjust", "spacing").attr("textLength", t.typeC4Shape.width).attr("x", t.x + t.width / 2 - t.typeC4Shape.width / 2).attr("y", t.y + t.typeC4Shape.Y).text("<<" + t.typeC4Shape.text + ">>"), t.typeC4Shape.text) {
		case "person":
		case "external_person": fe(s, 48, 48, t.x + t.width / 2 - 24, t.y + t.image.Y, o);
	}
...
function Q(e, t, n, r, i) {
	if (!t[e].width) {
		if (n) t[e].text = m(t[e].text, i, r), t[e].textLines = t[e].text.split(s.lineBreakRegex).length, t[e].width = i, t[e].height = h(t[e].text, r);
		else {
			let n = t[e].text.split(s.lineBreakRegex);
			t[e].textLines = n.length;
			let i = 0;
			t[e].height = 0, t[e].width = 0;
			for (let a of n) t[e].width = Math.max(g(a, r), t[e].width), i = h(a, r), t[e].height = t[e].height + i;
		}
	}
}
...
var Ne = /* @__PURE__ */ e(function(e, t, n) {
	...
	i.fontSize += 2, i.fontWeight = "bold", Q("label", t, r, i, g(t.label.text, i)), X.drawBoundary(e, t, Z);
}, "drawBoundary"), Pe = /* @__PURE__ */ e(function(e, t, n, r) {
	let i = 0;
	for (let a of r) {
		i = 0;
		let r = n[a], o = Ae(Z, r.typeC4Shape.text);
		switch (o.fontSize -= 2, r.typeC4Shape.width = g("«" + r.typeC4Shape.text + "»", o), r.typeC4Shape.height = o.fontSize + 2, r.typeC4Shape.Y = Z.c4ShapePadding, i = r.typeC4Shape.Y + r.typeC4Shape.height - 4, r.image = {
			width: 0,
			height: 0,
			Y: 0
		}, r.typeC4Shape.text) {
			case "person":
			case "external_person": r.image.width = 48, r.image.height = 48, r.image.Y = i, i = r.image.Y + r.image.height;
		}
	...
	for (let e of t) {
		...
		let o = g(e.label.text, i);
		Q("label", e, t, i, o), e.techn && e.techn.text !== "" && (o = g(e.techn.text, i), Q("techn", e, t, i, o)), e.descr && e.descr.text !== "" && (o = g(e.descr.text, i), Q("descr", e, t, i, o));
...
var ze = {
	...
	draw: /* @__PURE__ */ e(function(e, r, i, o) {
		...
		o.db.setWrap(Z.wrap), Ee = f.getC4ShapeInRow(), De = f.getC4BoundaryInRow(), t.debug(`C:${JSON.stringify(Z, null, 2)}`);
		...
		let h = o.db.getTitle();
		Re(p, "", m, o.db.getBoundaries(""), o), X.insertArrowHead(p, r), X.insertArrowEnd(p, r), X.insertArrowCrossHead(p, r), X.insertArrowFilledHead(p, r), Le(p, o.db.getRels(), o.db.getC4Shape, o, r), m.data.stopx = we, m.data.stopy = Te;
