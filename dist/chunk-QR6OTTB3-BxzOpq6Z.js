...
import { m as t, p as n } from "./src-BfmkUsMs.js";
import { A as r, B as i, M as a, T as o, b as s, g as c, x as l, z as u } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { a as d, r as f, u as p } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { t as m } from "./chunk-4I5QYGJK-_sTbXS-x.js";
import { n as h } from "./chunk-WRU74C26-2tQNDD2Y.js";
import { n as g, t as _ } from "./chunk-UBXNYLIW-B89mmlsE.js";
import { a as v, i as y, r as b, t as x } from "./chunk-W5SLKNZC-Bs8d-RNY.js";
import { t as S } from "./rough.esm-BSej9Nhy.js";
...
var C = /* @__PURE__ */ e(async (e, t, r) => {
	let i, a = t.useHtmlLabels || c(l()?.htmlLabels);
	i = r || "node default";
	let o = e.insert("g").attr("class", i).attr("id", t.domId || t.id), s = o.insert("g").attr("class", "label").attr("style", p(t.labelStyle)), f;
	f = t.label === void 0 ? "" : typeof t.label == "string" ? t.label : t.label[0];
	let m = !!t.icon || !!t.img, g = t.labelType === "markdown", v = await h(s, u(d(f), l()), {
		useHtmlLabels: a,
		...
		addSvgBackground: m,
		markdown: g
	}, l()), y = v.getBBox(), b = (t?.padding ?? 0) / 2;
	if (a) {
		let e = v.children[0], t = n(v);
		await _(e, f), y = e.getBoundingClientRect(), t.attr("width", y.width), t.attr("height", y.height);
	}
	return a ? s.attr("transform", "translate(" + -y.width / 2 + ", " + -y.height / 2 + ")") : s.attr("transform", "translate(0, " + -y.height / 2 + ")"), t.centerLabel && s.attr("transform", "translate(" + -y.width / 2 + ", " + -y.height / 2 + ")"), s.insert("rect", ":first-child"), {
		shapeSvg: o,
		bbox: y,
		halfPadding: b,
		label: s
	...
	let i = r.useHtmlLabels ?? o(l()), a = e.insert("g").attr("class", "label").attr("style", r.labelStyle || ""), s = await h(a, u(d(t), l()), {
		useHtmlLabels: i,
...
var j = /* @__PURE__ */ e((e, t) => {
	...
	let i = l(), { themeVariables: a, handDrawnSeed: o } = i, { clusterBkg: s, clusterBorder: u } = a, d = u, { labelStyles: f, nodeStyles: p, borderStyles: m, backgroundStyles: g } = y(r), _ = e.insert("g").attr("class", "cluster swimlane " + (r.cssClasses || "")).attr("id", r.id).attr("data-id", r.id).attr("data-et", "cluster").attr("data-look", r.look), b = c(i.flowchart.htmlLabels), x = r.direction === "LR", C = _.insert("g").attr("class", "cluster-label swimlane-label"), w = await h(C, r.label, {
		style: r.labelStyle,
		useHtmlLabels: b,
		isNode: !0,
		width: r.width
	...
	if (b) {
		let e = w.children[0], t = n(w);
		T = e.getBoundingClientRect(), t.attr("width", T.width), t.attr("height", T.height);
	}
	let E = r.padding ?? 0, D = r.width <= T.width + E ? T.width + E : r.width;
	r.diff = r.width <= T.width + E ? (D - r.width) / 2 - E : -E;
	let O = r.height, k = r.y - O / 2, A = r.y + O / 2, M = r.x - D / 2, N = r.swimlaneContentTop === void 0 ? k + O / 3 : r.swimlaneContentTop, P = x ? 4 : 0, F = T.height + 2 * P, I, L;
	if (x) {
		let e = Math.max(F, T.height + 2 * P), t = M + e, n = Math.max(0, D - e);
		if (r.look === "handDrawn") {
			let i = S.svg(_), a = v(r, {
				roughness: .7,
				fill: s,
				...
				stroke: d,
				seed: o
			}), l = i.rectangle(M, k, e, O, a);
			I = _.insert(() => l, ":first-child");
			let u = i.rectangle(t, k, n, O, c);
			L = _.insert(() => u, ":first-child"), I.select("path:nth-child(2)").attr("style", m.join(";")), I.select("path").attr("style", g.join(";").replace("fill", "stroke"));
		} else I = _.insert("rect", ":first-child"), L = _.insert("rect", ":first-child"), I.attr("class", "swimlane-title").attr("style", p).attr("x", M).attr("y", k).attr("width", e).attr("height", O).attr("fill", s).attr("stroke", d), L.attr("class", "swimlane-body").attr("style", p).attr("x", t).attr("y", k).attr("width", n).attr("height", O).attr("fill", "none").attr("stroke", d);
		let i = M + e / 2, a = r.y;
		C.attr("transform", `translate(${i}, ${a}) rotate(-90) translate(${-T.width / 2}, ${-T.height / 2})`);
	} else {
		let e = Math.max(0, N - k), t = Math.min(F, e), n = k + t, i = Math.max(0, A - n), a = r.x - D / 2;
		if (r.look === "handDrawn") {
			let e = S.svg(_), c = v(r, {
				roughness: .7,
				fill: s,
				...
				stroke: d,
				seed: o
			}), u = e.rectangle(a, k, D, t, c);
			I = _.insert(() => u, ":first-child");
			let f = e.rectangle(a, n, D, i, l);
			L = _.insert(() => f, ":first-child"), I.select("path:nth-child(2)").attr("style", m.join(";")), I.select("path").attr("style", g.join(";").replace("fill", "stroke"));
		} else I = _.insert("rect", ":first-child"), L = _.insert("rect", ":first-child"), I.attr("class", "swimlane-title").attr("style", p).attr("x", a).attr("y", k).attr("width", D).attr("height", t).attr("fill", s).attr("stroke", d), L.attr("class", "swimlane-body").attr("style", p).attr("x", a).attr("y", n).attr("width", D).attr("height", i).attr("fill", "none").attr("stroke", d);
		let c = r.x - T.width / 2, l = k + (t - T.height) / 2;
		C.attr("transform", `translate(${c}, ${l})`);
	}
	if (t.trace("Swimlane data ", r, JSON.stringify(r)), f) {
		let e = C.select("span");
		e && e.attr("style", f);
	}
	return r.offsetX = 0, r.width = D, r.height = O, r.offsetY = T.height - E / 2, r.intersect = function(e) {
		return j(r, e);
	}, {
		cluster: _,
		labelBBox: T
	...
	r.diff = r.width <= w.width + r.padding ? (T - r.width) / 2 - r.padding : -r.padding;
	...
	roundedWithTitle: /* @__PURE__ */ e(async (e, t) => {
		...
		t.diff = t.width <= _.width + t.padding ? (b - t.width) / 2 - t.padding : -t.padding;
	...
	swimlane: P
}, L = /* @__PURE__ */ new Map(), ee = /* @__PURE__ */ e(async (e, t) => {
	let n = await I[t.shape || "rect"](e, t);
	return L.set(t.id, n), n;
}, "insertCluster"), R = /* @__PURE__ */ e(() => {
	L = /* @__PURE__ */ new Map();
}, "clear");
function z(e, t) {
...
function K(e, n) {
	...
	return d.attr("class", "anchor").attr("style", p(s)), T(n, d), n.intersect = function(e) {
		return t.info("Circle intersect", n, 1, e), G.circle(n, 1, e);
	}, o;
}
e(K, "anchor");
...
async function se(t, n) {
	...
	let a = n.padding ?? 0, o = n.look === "neo" ? 16 : a, s = n.look === "neo" ? 12 : a, c = /* @__PURE__ */ e((e) => e + s, "calcTotalHeight"), l = /* @__PURE__ */ e((e) => {
		let t = e / 2;
		return [t / (2.5 + e / 50), t];
	}, "calcEllipseRadius"), { shapeSvg: u, bbox: d } = await C(t, n, E(n)), f = c(n?.height ? n?.height : d.height), [p, m] = l(f), h = oe(f, p, m), g = (n?.width ? n?.width : d.width) + o * 2 + h - h, _ = f, { cssStyles: b } = n, x = [
		{
			x: g / 2,
			y: -_ / 2
		},
		...
		...ae(-g / 2, -_ / 2, -g / 2, _ / 2, p, m, !1),
		{
			x: g / 2,
			y: _ / 2
		},
		...ae(g / 2, _ / 2, g / 2, -_ / 2, p, m, !0)
	], w = S.svg(u), O = v(n, {});
...
async function le(e, t) {
	...
	t.labelStyle = n;
	let i = t.padding ?? 0, a = t.look === "neo" ? 28 : i, o = t.look === "neo" ? 24 : i, { shapeSvg: s, bbox: c } = await C(e, t, E(t)), l = (t?.width ?? c.width) + (t.look === "neo" ? a * 2 : a + ce), u = (t?.height ?? c.height) + (t.look === "neo" ? o * 2 : o), d = l, f = -u, p = [
		{
			x: 0 + ce,
			y: f
		},
...
async function de(e, n, r) {
	...
	return T(n, d), n.calcIntersect = function(e, t) {
		let n = e.width / 2;
		return G.circle(e, n, t);
	}, n.intersect = function(e) {
		return t.info("Circle intersect", n, u, e), G.circle(n, u, e);
	}, o;
}
e(de, "circle");
function fe(e) {
...
function pe(e, n) {
	...
	let a = e.insert("g").attr("class", E(n)).attr("id", n.domId ?? n.id), o = Math.max(30, n?.width ?? 0), { cssStyles: s } = n, c = S.svg(a), l = v(n, {});
	n.look !== "handDrawn" && (l.roughness = 0, l.fillStyle = "solid");
	let u = c.circle(0, 0, o * 2, l), d = fe(o), f = c.path(d, l), p = a.insert(() => u, ":first-child");
...
async function _e(e, t) {
	...
	return A.attr("class", "basic label-container outer-path"), f && t.look !== "handDrawn" && A.selectChildren("path").attr("style", f), r && t.look !== "handDrawn" && A.selectChildren("path").attr("style", r), A.attr("transform", `translate(${-l / 2}, ${-u / 2})`), T(t, A), t.intersect = function(e) {
		return G.polygon(t, x, e);
	}, s;
}
e(_e, "curvedTrapezoid");
var ve = /* @__PURE__ */ e((e, t, n, r, i, a) => [
	`M${e},${t + a}`,
	`a${i},${a} 0,0,0 ${n},0`,
	`a${i},${a} 0,0,0 ${-n},0`,
	`l0,${r}`,
	`a${i},${a} 0,0,0 ${n},0`,
	`l0,${-r}`
].join(" "), "createCylinderPathD"), ye = /* @__PURE__ */ e((e, t, n, r, i, a) => [
	`M${e},${t + a}`,
	`M${e + n},${t + a}`,
	`a${i},${a} 0,0,0 ${-n},0`,
	`l0,${r}`,
	`a${i},${a} 0,0,0 ${n},0`,
	`l0,${-r}`
].join(" "), "createOuterCylinderPathD"), be = /* @__PURE__ */ e((e, t, n, r, i, a) => [`M${e - n / 2},${-r / 2}`, `a${i},${a} 0,0,0 ${n},0`].join(" "), "createInnerCylinderPathD"), xe = 8, Se = 8;
async function Ce(e, t) {
	...
	if (t.width || t.height) {
		let e = t.width ?? 0;
		t.width = (t.width ?? 0) - o, t.width < Se && (t.width = Se);
		let n = e / 2 / (2.5 + e / 50);
		t.height = (t.height ?? 0) - a - n * 3, t.height < xe && (t.height = xe);
	}
	...
	if (t.look === "handDrawn") {
		let e = S.svg(s), n = ye(0, 0, u, m, d, f), r = be(0, f, u, m, d, f), i = v(t, {}), a = e.path(n, i), o = e.path(r, v(t, { fill: "none" }));
		h = s.insert(() => o, ":first-child"), h = s.insert(() => a, ":first-child"), h.attr("class", "basic label-container"), g && h.attr("style", g);
	} else {
		let e = ve(0, 0, u, m, d, f);
...
async function Te(e, t) {
	let { cssClasses: n, labelPaddingX: r, labelPaddingY: i, padding: a, width: o, height: s } = t, c = await we(e, t, {
		rx: 0,
		ry: 0,
		classes: n ?? "",
...
async function De(e, n) {
	...
	return T(n, f), n.intersect = function(e) {
		return t.info("DoubleCircle intersect", n, u, e), G.circle(n, u, e);
	}, c;
}
e(De, "doublecircle");
function Oe(e, n, { config: { themeVariables: r } }) {
	let { labelStyles: i, nodeStyles: a } = y(n);
	n.label = "", n.labelStyle = i;
	let o = e.insert("g").attr("class", E(n)).attr("id", n.domId ?? n.id), { cssStyles: s } = n, c = S.svg(o), { nodeBorder: l } = r, u = v(n, { fillStyle: "solid" });
...
async function je(e, n) {
	...
	(n.width || n.height) && (n.height = n?.height ?? 0, n.height < ke && (n.height = ke), n.width = (n?.width ?? 0) - o - o / 2, n.width < Ae && (n.width = Ae));
	...
	return m && n.look !== "handDrawn" && x.selectChildren("path").attr("style", m), i && n.look !== "handDrawn" && x.selectChildren("path").attr("style", i), n.width = u, n.height = d, T(n, x), l.attr("transform", `translate(${-c.width / 2 - (c.x - (c.left ?? 0))}, ${-d / 2 + (n.padding ?? 0) / 2 + (c.y - (c.top ?? 0))})`), n.intersect = function(e) {
		return t.info("Triangle intersect", n, p, e), G.polygon(n, p, e);
	}, s;
}
e(je, "flippedTriangle");
function Me(e, t, { dir: n, config: { state: r, themeVariables: i } }) {
...
async function Ne(e, n) {
	...
	let { shapeSvg: s, bbox: c } = await C(e, n, E(n)), l = (n?.width ? n?.width : Math.max(15, c.width)) + a * 2, u = (n?.height ? n?.height : Math.max(10, c.height)) + o * 2, d = u / 2, { cssStyles: f } = n, p = S.svg(s), m = v(n, {});
...
e(Ne, "halfRoundedRectangle");
var Pe = /* @__PURE__ */ e((e, t, n, r, i) => [
	`M${e + i},${t}`,
	`L${e + n - i},${t}`,
	`L${e + n},${t - r / 2}`,
	`L${e + n - i},${t - r}`,
...
async function Fe(e, t) {
	...
	if (t.look === "handDrawn") {
		let e = S.svg(c), n = v(t, {}), r = Pe(0, 0, f, u, d), i = e.path(r, n);
...
async function Ie(e, n) {
	...
	let { shapeSvg: a } = await C(e, n, E(n)), o = Math.max(30, n?.width ?? 0), s = Math.max(30, n?.height ?? 0), { cssStyles: c } = n, l = S.svg(a), u = v(n, {});
	...
	return m.attr("class", "basic label-container outer-path"), c && n.look !== "handDrawn" && m.selectChildren("path").attr("style", c), i && n.look !== "handDrawn" && m.selectChildren("path").attr("style", i), m.attr("transform", `translate(${-o / 2}, ${-s / 2})`), T(n, m), n.intersect = function(e) {
		return t.info("Pill intersect", n, { points: d }), G.polygon(n, d, e);
	}, a;
}
e(Ie, "hourglass");
async function Le(e, n, { config: { themeVariables: r, flowchart: i } }) {
	...
	let { shapeSvg: u, bbox: d, label: f } = await C(e, n, "icon-shape default"), p = n.pos === "t", h = c, g = c, { nodeBorder: _ } = r, { stylesMap: b } = x(n), w = -g / 2, E = -h / 2, D = n.label ? 8 : 0, O = S.svg(u), k = v(n, {
		stroke: "none",
		fill: "none"
	});
	n.look !== "handDrawn" && (k.roughness = 0, k.fillStyle = "solid");
	let A = O.rectangle(w, E, g, h, k), j = Math.max(g, d.width), M = h + d.height + D, N = O.rectangle(-j / 2, -M / 2, j, M, {
		...k,
		fill: "transparent",
		stroke: "none"
	...
	return f.attr("transform", `translate(${-d.width / 2 - (d.x - (d.left ?? 0))},${p ? -M / 2 : M / 2 - d.height})`), P.attr("transform", `translate(0,${p ? d.height / 2 + D / 2 : -d.height / 2 - D / 2})`), T(n, F), n.intersect = function(e) {
		if (t.info("iconSquare intersect", n, e), !n.label) return G.rect(n, e);
...
async function Re(e, n, { config: { themeVariables: r, flowchart: i } }) {
	...
	let o = n.assetHeight ?? 48, s = n.assetWidth ?? 48, c = Math.max(o, s), l = i?.wrappingWidth;
	n.width = Math.max(c, l ?? 0);
	let { shapeSvg: u, bbox: d, label: f } = await C(e, n, "icon-shape default"), p = n.label ? 8 : 0, h = n.pos === "t", { nodeBorder: g, mainBkg: _ } = r, { stylesMap: b } = x(n), w = S.svg(u), E = v(n, {});
	n.look !== "handDrawn" && (E.roughness = 0, E.fillStyle = "solid"), E.stroke = b.get("fill") ?? _;
	let D = u.append("g");
	n.icon && D.html(`<g>${await m(n.icon, {
		height: c,
		width: c,
		fallbackPrefix: ""
	})}</g>`);
	...
	return D.attr("transform", `translate(${-k / 2 - j},${h ? d.height / 2 + p / 2 - A / 2 - M : -d.height / 2 - p / 2 - A / 2 - M})`), D.attr("style", `color: ${b.get("stroke") ?? g};`), f.attr("transform", `translate(${-d.width / 2 - (d.x - (d.left ?? 0))},${h ? -I / 2 : I / 2 - d.height})`), ee.attr("transform", `translate(0,${h ? d.height / 2 + p / 2 : -d.height / 2 - p / 2})`), T(n, R), n.intersect = function(e) {
		return t.info("iconSquare intersect", n, e), G.rect(n, e);
	}, u;
}
e(Re, "iconCircle");
async function ze(e, n, { config: { themeVariables: r, flowchart: i } }) {
	...
	let o = n.assetHeight ?? 48, s = n.assetWidth ?? 48, c = Math.max(o, s), l = i?.wrappingWidth;
	n.width = Math.max(c, l ?? 0);
	let { shapeSvg: u, bbox: d, halfPadding: f, label: p } = await C(e, n, "icon-shape default"), h = n.pos === "t", g = c + f * 2, _ = c + f * 2, { nodeBorder: b, mainBkg: w } = r, { stylesMap: E } = x(n), D = -_ / 2, O = -g / 2, k = n.label ? 8 : 0, A = S.svg(u), j = v(n, {});
	...
	let M = A.path(N(D, O, _, g, 5), j), P = Math.max(_, d.width), F = g + d.height + k, I = A.rectangle(-P / 2, -F / 2, P, F, {
		...
		fill: "transparent",
		stroke: "none"
	}), L = u.insert(() => M, ":first-child").attr("class", "icon-shape2"), ee = u.insert(() => I);
	if (n.icon) {
		let e = u.append("g");
		e.html(`<g>${await m(n.icon, {
			height: c,
		...
		let t = e.node().getBBox(), r = t.width, i = t.height, a = t.x, o = t.y;
		e.attr("transform", `translate(${-r / 2 - a},${h ? d.height / 2 + k / 2 - i / 2 - o : -d.height / 2 - k / 2 - i / 2 - o})`), e.attr("style", `color: ${E.get("stroke") ?? b};`);
	}
	return p.attr("transform", `translate(${-d.width / 2 - (d.x - (d.left ?? 0))},${h ? -F / 2 : F / 2 - d.height})`), L.attr("transform", `translate(0,${h ? d.height / 2 + k / 2 : -d.height / 2 - k / 2})`), T(n, ee), n.intersect = function(e) {
		if (t.info("iconSquare intersect", n, e), !n.label) return G.rect(n, e);
		let r = n.x ?? 0, i = n.y ?? 0, a = n.height ?? 0, o = [];
		return o = h ? [
			{
...
e(ze, "iconRounded");
async function Be(e, n, { config: { themeVariables: r, flowchart: i } }) {
	let { labelStyles: a } = y(n);
	n.labelStyle = a;
	let o = n.assetHeight ?? 48, s = n.assetWidth ?? 48, c = Math.max(o, s), l = i?.wrappingWidth;
	n.width = Math.max(c, l ?? 0);
	...
	let M = A.path(N(D, O, _, g, .1), j), P = Math.max(_, d.width), F = g + d.height + k, I = A.rectangle(-P / 2, -F / 2, P, F, {
		...
		fill: "transparent",
		stroke: "none"
	}), L = u.insert(() => M, ":first-child"), ee = u.insert(() => I);
	if (n.icon) {
		let e = u.append("g");
		e.html(`<g>${await m(n.icon, {
			height: c,
...
e(Be, "iconSquare");
async function Ve(e, n, { config: { flowchart: r } }) {
	let i = new Image();
	...
	let { shapeSvg: f, bbox: p, label: m } = await C(e, n, "image-shape default"), h = n.pos === "t", g = -u / 2, _ = -d / 2, b = n.label ? 8 : 0, x = S.svg(f), w = v(n, {});
...
function Ke(e, n) {
	...
	return m.attr("class", "outer-path"), o && n.look !== "handDrawn" && m.selectAll("path").attr("style", o), i && n.look !== "handDrawn" && m.selectAll("path").attr("style", i), m.attr("transform", `translate(-${s / 2},${-c})`), T(n, m), n.intersect = function(e) {
		return t.info("lightningBolt intersect", n, e), G.polygon(n, l, e);
	}, a;
}
e(Ke, "lightningBolt");
var qe = /* @__PURE__ */ e((e, t, n, r, i, a, o) => [
	`M${e},${t + a}`,
	`a${i},${a} 0,0,0 ${n},0`,
	`a${i},${a} 0,0,0 ${-n},0`,
	`l0,${r}`,
	...
	`M${e},${t + a + o}`,
	`a${i},${a} 0,0,0 ${n},0`
].join(" "), "createCylinderPathD"), Je = /* @__PURE__ */ e((e, t, n, r, i, a, o) => [
	`M${e},${t + a}`,
	`M${e + n},${t + a}`,
	`a${i},${a} 0,0,0 ${-n},0`,
	`l0,${r}`,
	...
	`M${e},${t + a + o}`,
	`a${i},${a} 0,0,0 ${n},0`
].join(" "), "createOuterCylinderPathD"), Ye = /* @__PURE__ */ e((e, t, n, r, i, a) => [`M${e - n / 2},${-r / 2}`, `a${i},${a} 0,0,0 ${n},0`].join(" "), "createInnerCylinderPathD"), Xe = 10, Ze = 10;
async function Qe(e, t) {
	...
	if (t.width || t.height) {
		let e = t.width ?? 0;
		t.width = (t.width ?? 0) - a, t.width < Ze && (t.width = Ze);
		let n = e / 2 / (2.5 + e / 50);
		t.height = (t.height ?? 0) - o - n * 3, t.height < Xe && (t.height = Xe);
	}
...
async function $e(e, t) {
	...
	return x.attr("class", "basic label-container outer-path"), m && t.look !== "handDrawn" && x.selectAll("path").attr("style", m), r && t.look !== "handDrawn" && x.selectAll("path").attr("style", r), x.attr("transform", `translate(0,${-f / 2})`), l.attr("transform", `translate(${-u / 2 + (t.padding ?? 0) + u / 2 * .1 / 2 - (c.x - (c.left ?? 0))},${-d / 2 + (t.padding ?? 0) - f / 2 - (c.y - (c.top ?? 0))})`), T(t, x), t.intersect = function(e) {
		return G.polygon(t, _, e);
	}, s;
}
e($e, "linedWaveEdgedRect");
...
e(tt, "multiWaveEdgedRectangle");
async function nt(e, t, { config: { themeVariables: n } }) {
	let { labelStyles: r, nodeStyles: i } = y(t);
...
async function it(e, t) {
	...
	if (t.look === "handDrawn") {
		let e = S.svg(i), n = v(t, {}), r = rt(0, 0, o), a = e.path(r, n);
...
function pt(e, t, { config: { themeVariables: n } }) {
	...
	return T(t, _), t.intersect = function(e) {
		return G.circle(t, (t.width ?? 0) / 2, e);
	}, u;
}
e(pt, "stateEnd");
function mt(e, t, { config: { themeVariables: n } }) {
	...
	return T(t, o), t.intersect = function(e) {
		return G.circle(t, (t.width ?? 7) / 2, e);
	}, a;
}
e(mt, "stateStart");
var ht = 8;
async function gt(e, t) {
	let { labelStyles: n, nodeStyles: r } = y(t);
	t.labelStyle = n;
	let i = t?.padding ?? 8, a = t.look === "neo" ? 28 : i, o = t.look === "neo" ? 12 : i, { shapeSvg: s, bbox: c } = await C(e, t, E(t)), l = (t?.width ?? c.width) + 2 * ht + a, u = (t?.height ?? c.height) + o, d = l - 2 * ht, f = u, m = -l / 2, h = -u / 2, g = [
		{
			x: 0,
			y: 0
		},
	...
	if (t.look === "handDrawn") {
		let e = S.svg(s), n = v(t, {}), r = e.rectangle(m, h, d + 16, f, n), i = e.line(m + ht, h, m + ht, h + f, n), a = e.line(m + ht + d, h, m + ht + d, h + f, n);
...
async function vt(e, t) {
	...
	t.labelStyle = n;
	let i = t.padding ?? 0, a = t.look === "neo" ? 16 : i, o = t.look === "neo" ? 12 : i;
	(t.width || t.height) && (t.height = Math.max((t?.height ?? 0) - o * 2, 10), t.width = Math.max((t?.width ?? 0) - a * 2 - _t * (t.height + o * 2), 10));
	let { shapeSvg: s, bbox: c } = await C(e, t, E(t)), l = (t?.height ? t?.height : c.height) + o * 2, u = _t * l, d = _t * l, f = (t?.width ? t?.width : c.width) + a * 2 + u - u, p = l, m = -f / 2, h = -p / 2, { cssStyles: g } = t, _ = S.svg(s), b = v(t, {}), x = [
		{
			x: m - u / 2,
			y: h
		},
...
e(bt, "text");
var xt = /* @__PURE__ */ e((e, t, n, r, i, a) => `M${e},${t}
    a${i},${a} 0,0,1 0,${-r}
    l${n},0
    a${i},${a} 0,0,1 0,${r}
    M${n},${-r}
    a${i},${a} 0,0,0 0,${r}
    l${-n},0`, "createCylinderPathD"), St = /* @__PURE__ */ e((e, t, n, r, i, a) => [
	`M${e},${t}`,
	`M${e + n},${t}`,
	`a${i},${a} 0,0,0 0,${-r}`,
	`l${-n},0`,
	`a${i},${a} 0,0,0 0,${r}`,
	`l${n},0`
].join(" "), "createOuterCylinderPathD"), Ct = /* @__PURE__ */ e((e, t, n, r, i, a) => [`M${e + n / 2},${-r / 2}`, `a${i},${a} 0,0,0 0,${r}`].join(" "), "createInnerCylinderPathD"), wt = 5, Tt = 10;
async function Et(e, t) {
	let { labelStyles: n, nodeStyles: r } = y(t);
	t.labelStyle = n;
	...
	if (t.width || t.height) {
		let e = t.height ?? 0;
		t.height = (t.height ?? 0) - a, t.height < wt && (t.height = wt);
		let n = e / 2 / (2.5 + e / 50);
		t.width = (t.width ?? 0) - a - n * 3, t.width < Tt && (t.width = Tt);
	}
	...
	if (t.look === "handDrawn") {
		let e = S.svg(o), n = St(0, 0, f, l, d, u), r = Ct(0, 0, f, l, d, u), i = e.path(n, v(t, {})), a = e.path(r, v(t, { fill: "none" }));
		h = o.insert(() => a, ":first-child"), h = o.insert(() => i, ":first-child"), h.attr("class", "basic label-container"), m && h.attr("style", m);
	} else {
		let e = xt(0, 0, f, l, d, u);
...
e(Ot, "trapezoidalPentagon");
var kt = 10, At = 10;
async function jt(e, n) {
	let { labelStyles: r, nodeStyles: i } = y(n);
	n.labelStyle = r;
	let a = n.padding ?? 0, o = n.look === "neo" ? a * 2 : a;
	(n.width || n.height) && (n.width = ((n?.width ?? 0) - o) / 2, n.width < At && (n.width = At), n.height = n?.height ?? 0, n.height < kt && (n.height = kt));
	let { shapeSvg: s, bbox: u, label: d } = await C(e, n, E(n)), f = c(l().flowchart?.htmlLabels), p = (n?.width ? n?.width : u.width) + o, m = n?.height ? n?.height : p + u.height, h = m, g = [
		{
			x: 0,
			y: 0
		},
	...
	return _ && n.look !== "handDrawn" && k.selectChildren("path").attr("style", _), i && n.look !== "handDrawn" && k.selectChildren("path").attr("style", i), n.width = p, n.height = m, T(n, k), d.attr("transform", `translate(${-u.width / 2 - (u.x - (u.left ?? 0))}, ${m / 2 - (u.height + (n.padding ?? 0) / (f ? 2 : 1) - (u.y - (u.top ?? 0)))})`), n.intersect = function(e) {
		return t.info("Triangle intersect", n, g, e), G.polygon(n, g, e);
	}, s;
}
e(jt, "triangle");
...
async function Pt(e, t) {
	...
	return D.attr("transform", `translate(${Q / 2}, ${Q / 2})`), D.attr("class", "basic label-container outer-path"), h && t.look !== "handDrawn" && D.selectAll("path").attr("style", h), r && t.look !== "handDrawn" && D.selectAll("path").attr("style", r), c.attr("transform", `translate(${-(s.width / 2) + Q / 2 - (s.x - (s.left ?? 0))}, ${-(s.height / 2) + Q / 2 - (s.y - (s.top ?? 0))})`), T(t, D), t.intersect = function(e) {
		return G.polygon(t, b, e);
	}, o;
}
e(Pt, "windowPane");
var Ft = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), It = /* @__PURE__ */ new Set([
	"redux",
	"redux-dark",
	"redux-color",
	"redux-dark-color"
...
async function Lt(e, t) {
	...
	let m = p.er?.diagramPadding ?? 10, h = p.er?.entityPadding ?? 6, { cssStyles: g } = t, { labelStyles: _, nodeStyles: b } = y(t);
	if (r.attributes.length === 0 && t.label) {
		...
		f(t.label, p) + n.labelPaddingX * 2 < p.er.minEntityWidth && (t.width = p.er.minEntityWidth);
		let a = await we(e, t, n);
		if (i != null && Ft.has(i)) {
	...
	let x = E(t);
	x ||= "node default";
	let C = e.insert("g").attr("class", x).attr("id", t.domId || t.id), w = await Rt(C, t.label ?? "", p, 0, 0, ["name"], _);
	w.height += h;
	let D = 0, O = [], k = [], A = 0, j = 0, M = 0, N = 0, P = !0, F = !0;
	for (let e of r.attributes) {
		let t = await Rt(C, e.type, p, 0, D, ["attribute-type"], _);
		A = Math.max(A, t.width + m);
		let n = await Rt(C, e.name, p, 0, D, ["attribute-name"], _);
		j = Math.max(j, n.width + m);
		let r = await Rt(C, e.keys.join(), p, 0, D, ["attribute-keys"], _);
		M = Math.max(M, r.width + m);
		let i = await Rt(C, e.comment, p, 0, D, ["attribute-comment"], _);
	...
	let ee = A + j + M + N, R = S.svg(C), z = v(t, {});
	t.look !== "handDrawn" && (z.roughness = 0, z.fillStyle = "solid");
	let te = 0;
	k.length > 0 && (te = k.reduce((e, t) => e + (t?.rowHeight ?? 0), 0));
	let B = Math.max(L.width + m * 2, t?.width || 0, ee), V = Math.max((te ?? 0) + w.height, t?.height || 0), H = -B / 2, U = -V / 2;
	if (C.selectAll("g:not(:first-child)").each((e, t, r) => {
		...
		i.attr("transform", `translate(${H + m / 2 + o}, ${s + U + w.height + h / 2})`);
	}), C.select(".name").attr("transform", "translate(" + -w.width / 2 + ", " + (U + h / 2) + ")"), i != null && Ft.has(i)) {
		let e = r.colorIndex ?? 0;
		C.attr("data-color-id", `color-${e % d.length}`);
	}
	let ne = R.rectangle(H, U, B, V, z), re = C.insert(() => ne, ":first-child").attr("class", "outer-path").attr("style", g.join(""));
	O.push(0);
	for (let [e, t] of k.entries()) {
		let n = (e + 1) % 2 == 0 && t.yOffset !== 0, r = R.rectangle(H, w.height + U + t?.yOffset, B, t?.rowHeight, {
			...z,
			fill: n ? o : l,
			stroke: u
		});
	...
	let ie = 1e-4, W = zt(H, w.height + U, B + H, w.height + U, ie), K = R.polygon(W.map((e) => [e.x, e.y]), z);
	if (C.insert(() => K).attr("class", "divider"), W = zt(A + H, w.height + U, A + H, V + U, ie), K = R.polygon(W.map((e) => [e.x, e.y]), z), C.insert(() => K).attr("class", "divider"), P) {
		let e = A + j + H;
		W = zt(e, w.height + U, e, V + U, ie), K = R.polygon(W.map((e) => [e.x, e.y]), z), C.insert(() => K).attr("class", "divider");
	}
	if (F) {
		let e = A + j + M + H;
		W = zt(e, w.height + U, e, V + U, ie), K = R.polygon(W.map((e) => [e.x, e.y]), z), C.insert(() => K).attr("class", "divider");
	...
	for (let e of O) {
		let t = w.height + U + e;
		W = zt(H, t, B + H, t, ie), K = R.polygon(W.map((e) => [e.x, e.y]), z), C.insert(() => K).attr("class", "divider");
	}
	if (T(t, re), b && t.look !== "handDrawn") {
		if (i != null && It.has(i)) C.selectAll("path").attr("style", b);
		else {
...
e(Lt, "erBox");
async function Rt(e, t, r, i = 0, o = 0, s = [], l = "") {
...
async function Bt(e, t, n, r, i = n.class.padding ?? 12) {
	...
	if (s = o.insert("g").attr("class", "annotation-group text"), t.annotations.length > 0) {
		...
		await Vt(s, { text: `\xAB${e}\xBB` }, 0), d = s.node().getBBox().height;
	}
	c = o.insert("g").attr("class", "label-group text"), await Vt(c, t, 0, ["font-weight: bolder"]);
	let m = c.node().getBBox();
	f = m.height, l = o.insert("g").attr("class", "members-group text");
	let h = 0;
	for (let e of t.members) {
		let t = await Vt(l, e, h, [e.parseClassifier()]);
		h += t + a;
	}
	p = l.node().getBBox().height, p <= 0 && (p = i / 2), u = o.insert("g").attr("class", "methods-group text");
	let g = 0;
	for (let e of t.methods) {
		let t = await Vt(u, e, g, [e.parseClassifier()]);
		g += t + a;
	}
...
e(Bt, "textHelper");
async function Vt(t, a, o, l = []) {
	let u = t.insert("g").attr("class", "label").attr("style", l.join("; ")), p = s(), m = "useHtmlLabels" in a ? a.useHtmlLabels : c(p.htmlLabels) ?? !0, g = "";
	g = "text" in a ? a.text : a.label, !m && g.startsWith("\\") && (g = g.substring(1)), r(g) && (m = !0);
	let _ = await h(u, i(d(g)), {
		width: f(g, p) + 50,
		classes: "markdown-node-label",
		useHtmlLabels: m
	}, p), v, y = 1;
	if (m) {
		let t = _.children[0], r = n(_);
		...
		v = t.getBoundingClientRect(), r.attr("width", v.width), r.attr("height", v.height);
	} else {
		l.includes("font-weight: bolder") && n(_).selectAll("tspan").attr("font-weight", ""), y = _.children.length;
		let e = _.children[0];
...
async function Ht(e, t) {
	let r = l(), { themeVariables: i } = r, { useGradient: a } = i, o = r.class.padding ?? 12, s = o, u = t.useHtmlLabels ?? c(r.htmlLabels) ?? !0, d = t;
	d.annotations = d.annotations ?? [], d.members = d.members ?? [], d.methods = d.methods ?? [];
	let { shapeSvg: f, bbox: p } = await Bt(e, t, r, u, s), { labelStyles: m, nodeStyles: h } = y(t);
	...
	if (f.selectAll(".text").each((e, t, i) => {
		let a = n(i[t]), c = a.attr("transform"), l = 0;
		if (c) {
		...
		let e = N + P + O + o, n = b.line(M.x, e, M.x + M.width, e + .001, x);
		f.insert(() => n).attr("class", `divider${t.look === "neo" && !a ? " neo-line" : ""}`).attr("style", g);
	}
	if (_ || d.members.length > 0 || d.methods.length > 0) {
		let e = N + P + F + O + s * 2 + o, n = b.line(M.x, E ? Math.max(I, e) : e, M.x + M.width, (E ? Math.max(I, e) : e) + .001, x);
		f.insert(() => n).attr("class", `divider${t.look === "neo" && !a ? " neo-line" : ""}`).attr("style", g);
	}
...
async function Ut(e, t) {
	let { labelStyles: r, nodeStyles: i } = y(t);
	t.labelStyle = r;
	let a = t, o = t, s = "verifyMethod" in t, c = E(t), { themeVariables: u } = l(), { borderColorArray: d, requirementEdgeLabelBackground: f } = u, p = e.insert("g").attr("class", c).attr("id", t.domId ?? t.id), m;
...
async function $(e, t, r, a = "") {
	if (t === "") return 0;
	let o = e.insert("g").attr("class", "label").attr("style", a), s = l(), c = s.htmlLabels ?? !0, u = await h(o, i(d(t)), {
		width: f(t, s) + 50,
		classes: "markdown-node-label",
		useHtmlLabels: c,
		style: a
...
async function Kt(e, n) {
  ...
  H0 V0 Z`;
	...
	return b.attr("transform", `translate(${-g / 2}, ${-_ / 2})`), T(n, b), n.calcIntersect = function(e, t) {
		...
		return t.info("Bang intersect", n, e), G.rect(n, e);
	}, a;
}
e(Kt, "bang");
async function qt(e, n) {
  ...
  H0 V0 Z`;
	...
	return c.attr("transform", `translate(${-o.width / 2}, ${-o.height / 2})`), _.attr("transform", `translate(${-l / 2}, ${-u / 2})`), T(n, _), n.calcIntersect = function(e, t) {
		...
		return t.info("Cloud intersect", n, e), G.rect(n, e);
	}, a;
}
e(qt, "cloud");
...
//#endregion
export { en as a, rn as c, ee as i, tn as l, nn as n, Qt as o, M as r, C as s, R as t, T as u };
