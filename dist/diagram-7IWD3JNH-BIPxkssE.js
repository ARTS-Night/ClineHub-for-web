...
import { H as r, K as i, U as a, a as o, b as s, c, f as l, v as u, w as d, y as f, z as p } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { i as m } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { t as h } from "./chunk-JWPE2WC7-os5Vwac_.js";
import { r as g, t as _ } from "./chunk-4I5QYGJK-_sTbXS-x.js";
import { t as v } from "./chunk-2Q5K7J3B--iCDRPtn.js";
import { a as y } from "./mermaid.core-CoIgm_7k.js";
...
var U = 14, W = 4, G = 16, K = /* @__PURE__ */ t((e, t) => `tv-icon-${e}-${t.replace(/[^\w-]/g, "-")}`, "iconSymbolId"), q = /* @__PURE__ */ t(async (e, n, r, i) => {
...
}, "drawTree"), Z = { draw: /* @__PURE__ */ t(async (e, t, r, i) => {
	n.debug("Rendering treeView diagram\n" + e);
	let a = i.db, o = a.getRoot(), s = a.getConfig(), l = y(t);
	await q(l, o, s, t);
	let u = l.append("g");
	u.attr("class", "tree-view");
	let { totalHeight: d, totalWidth: f } = X(u, o, s, t);
	...
	styles: /* @__PURE__ */ t(({ treeView: e }) => {
		let { labelFontSize: t, labelColor: n, lineColor: r, iconColor: i, descriptionColor: a, highlightBg: o, highlightStroke: s } = m(Q, e);
		return `
    .treeView-node-label {
        font-size: ${t};
        fill: ${n};
