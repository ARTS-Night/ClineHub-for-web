...
import { O as r, T as i, a, b as o, c as s, rt as c, s as l, x as u, z as d } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { t as f } from "./channel-D5F73w4K.js";
import { A as p, B as m, C as h, D as g, E as _, F as v, G as y, H as b, I as x, L as S, M as C, N as w, O as T, P as E, R as D, T as O, U as k, V as A, W as j, a as M, b as ee, et as te, g as N, j as ne, k as re, l as ie, v as ae, w as oe, z as se } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { t as ce } from "./line-B4kwC9Sr.js";
import "./chunk-4I5QYGJK-_sTbXS-x.js";
import { n as P } from "./chunk-WRU74C26-2tQNDD2Y.js";
import { t as le } from "./chunk-5VM5RSS4-DAnVCoXQ.js";
import { n as ue, t as F } from "./chunk-7BUUIJ7U-nEj9ozwq.js";
import { n as de, t as fe } from "./chunk-UBXNYLIW-B89mmlsE.js";
import { t as pe } from "./graphlib-feYbMzBj.js";
...
function he(e) {
	...
	if (t === "[object Boolean]" || t === "[object Number]" || t === "[object String]") {
		...
		return t === "[object String]" ? ye(r, e) : _e(r, e), r;
	}
	...
	if (t === "[object Arguments]") {
		let t = e, n = {};
		return _e(n, t), n.length = t.length, n[Symbol.iterator] = t[Symbol.iterator], n;
	}
	let n = {};
	return be(n, e), _e(n, e), ve(n, e), n;
}
function ge(e) {
	switch (y(e)) {
		case h:
...
xe.parser = xe;
var Se = xe, I = /* @__PURE__ */ new Map(), Ce = [], we = /* @__PURE__ */ new Map(), Te = "color", Ee = "fill", De = "bgFill", Oe = ",", L = /* @__PURE__ */ new Map(), ke = "", Ae = /* @__PURE__ */ e((e) => l.sanitizeText(e, u()), "sanitizeText"), je = /* @__PURE__ */ e(function(e, t = "") {
	let n = L.get(e);
	n || (n = {
		id: e,
		styles: [],
		textStyles: []
	}, L.set(e, n)), t?.split(Oe).forEach((e) => {
		let t = e.replace(/([^;]*);/, "$1").trim();
		if (RegExp(Te).exec(e)) {
			let e = t.replace(Ee, De).replace(Te, Ee);
			n.textStyles.push(e);
		}
		n.styles.push(t);
	});
}, "addStyleClass"), Me = /* @__PURE__ */ e(function(e, t = "") {
	let n = I.get(e);
	t != null && (n.styles = t.split(Oe));
}, "addStyle2Node"), Ne = /* @__PURE__ */ e(function(e, t) {
...
}, "setCssClass"), Pe = /* @__PURE__ */ e((e, n) => {
	let r = e.flat(), i = [], a = r.find((e) => e?.type === "column-setting")?.columns ?? -1;
	for (let e of r) {
		if (typeof a == "number" && a > 0 && e.type !== "column-setting" && typeof e.widthInColumns == "number" && e.widthInColumns > a && t.warn(`Block ${e.id} width ${e.widthInColumns} exceeds configured column width ${a}`), e.label &&= Ae(e.label), e.type === "classDef") {
			je(e.id, e.css);
			continue;
		}
		if (e.type === "applyClass") {
			Ne(e.id, e?.styleClass ?? "");
			continue;
		}
		if (e.type === "applyStyles") {
			e?.stylesStr && Me(e.id, e?.stylesStr);
			continue;
		}
		if (e.type === "column-setting") n.columns = e.columns ?? -1;
		else if (e.type === "edge") {
			let t = (we.get(e.id) ?? 0) + 1;
			we.set(e.id, t), e.id = t + "-" + e.id, Ce.push(e);
		} else {
			e.label ||= e.type === "composite" ? "" : e.id;
			let t = I.get(e.id);
			if (t === void 0 ? I.set(e.id, e) : (e.type !== "na" && (t.type = e.type), e.label !== e.id && (t.label = e.label)), e.children && Pe(e.children, e), e.type === "space") {
				let t = e.width ?? 1;
				for (let n = 0; n < t; n++) {
					let t = he(e);
	...
	n.children = i;
}, "populateBlockDatabase"), Fe = [], R = {
	id: "root",
	type: "composite",
	children: [],
	columns: -1
}, Ie = /* @__PURE__ */ e(() => {
	t.debug("Clear called"), a(), R = {
		id: "root",
		type: "composite",
		children: [],
		columns: -1
	}, I = /* @__PURE__ */ new Map([["root", R]]), Fe = [], L = /* @__PURE__ */ new Map(), Ce = [], we = /* @__PURE__ */ new Map(), ke = "";
}, "clear");
function Le(e) {
...
e(Be, "edgeStrToEdgeStartData");
function Ve(e) {
	return e.includes("==") ? "thick" : "normal";
}
e(Ve, "edgeStrToThickness");
function He(e) {
	return e.includes(".-") ? "dotted" : "solid";
}
e(He, "edgeStrToPattern");
var Ue = 0, We = {
	getConfig: /* @__PURE__ */ e(() => o().block, "getConfig"),
	typeStr2Type: Le,
	edgeTypeStr2Type: Re,
	edgeStrToEdgeData: ze,
	edgeStrToEdgeStartData: Be,
	edgeStrToThickness: Ve,
	edgeStrToPattern: He,
	getLogger: /* @__PURE__ */ e(() => t, "getLogger"),
	getBlocksFlat: /* @__PURE__ */ e(() => [...I.values()], "getBlocksFlat"),
	getBlocks: /* @__PURE__ */ e(() => Fe || [], "getBlocks"),
	getEdges: /* @__PURE__ */ e(() => Ce, "getEdges"),
	setHierarchy: /* @__PURE__ */ e((e) => {
		R.children = e, Pe(e, R), Fe = R.children;
	}, "setHierarchy"),
	...
	clear: Ie,
	generateId: /* @__PURE__ */ e(() => (Ue++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Ue), "generateId"),
	setDiagramId: /* @__PURE__ */ e((e) => {
		ke = e;
	}, "setDiagramId"),
	getDiagramId: /* @__PURE__ */ e(() => ke, "getDiagramId")
}, z = /* @__PURE__ */ e((e, t) => {
	let n = f, r = n(e, "r"), i = n(e, "g"), a = n(e, "b");
	return c(r, i, a, t);
  ...
  ${le()}
`, "getStyles"), Ke = /* @__PURE__ */ e((e, t, n, r) => {
	t.forEach((t) => {
		qe[t](e, n, r);
	});
}, "insertMarkers"), qe = {
...
function V(e, n, r = 0, i = 0, a = 8) {
	...
	if (e.children?.length > 0) {
		for (let t of e.children) V(t, n, 0, 0, a);
		let c = Ye(e);
		...
		for (let t of e.children) V(t, n, o, s, a);
...
function H(e, n, r = 8) {
	...
	if (t.debug("layoutBlocks columns abc95", e.id, "=>", i, e), e.children && e.children.length > 0) {
		...
		for (let a of e.children) {
			let o = e;
			if (!a.size) continue;
			let { width: f, height: p } = a.size, { px: m, py: h } = B(i, l);
...
e(H, "layoutBlocks");
function Xe(e, { minX: t, minY: n, maxX: r, maxY: i } = {
	minX: 0,
	minY: 0,
	maxX: 0,
	maxY: 0
	...
	if (e.children) for (let a of e.children) ({minX: t, minY: n, maxX: r, maxY: i} = Xe(a, {
		minX: t,
		minY: n,
		maxX: r,
		maxY: i
...
function Ze(e) {
	...
	if (!n) return;
	let r = u()?.block?.padding ?? 8;
	V(n, e, 0, 0, r), H(n, e, r), t.debug("getBlocks", JSON.stringify(n, null, 2));
	let { minX: i, minY: a, maxX: o, maxY: s } = Xe(n), c = s - a;
	return {
		x: i,
		y: a,
		width: o - i,
...
var U = /* @__PURE__ */ e(async (e, t, n, r = !1, a = !1) => {
	...
	let r = u(), a = i(r), o = e.insert("g").attr("class", "edgeLabel"), s = o.insert("g").attr("class", "label"), c = t.labelType === "markdown", l = await P(e, t.label, {
		style: t.labelStyle,
		useHtmlLabels: a,
		addSvgBackground: c,
		isNode: !1,
	...
	s.attr("transform", F(f, a)), tt[t.id] = o, t.width = d.width, t.height = d.height;
	let p;
	if (t.startLabelLeft) {
		...
		i.attr("transform", F(s, a)), W[t.id] || (W[t.id] = {}), W[t.id].startLeft = r, G(p, t.startLabelLeft);
	}
	if (t.startLabelRight) {
		...
		i.attr("transform", F(s, a)), W[t.id] || (W[t.id] = {}), W[t.id].startRight = r, G(p, t.startLabelRight);
	}
	if (t.endLabelLeft) {
		...
		i.attr("transform", F(s, a)), W[t.id] || (W[t.id] = {}), W[t.id].endLeft = r, G(p, t.endLabelLeft);
	}
	if (t.endLabelRight) {
		...
		i.attr("transform", F(s, a)), W[t.id] || (W[t.id] = {}), W[t.id].endRight = r, G(p, t.endLabelRight);
	}
	return l;
}, "insertEdgeLabel");
function G(e, t) {
...
var rt = /* @__PURE__ */ e((e, n) => {
	...
	let r = n.updatedPath ? n.updatedPath : n.originalPath, i = u(), { subGraphTitleTotalMargin: a } = de(i);
	if (e.label) {
		let i = tt[e.id], o = e.x, s = e.y;
		if (r) {
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
	...
	var p = s.node(n.w);
	p?.intersect && f?.intersect && (l = l.slice(1, i.points.length - 1), l.unshift(f.intersect(l[0])), l.push(p.intersect(l[l.length - 1]))), i.toCluster && (t.debug("to cluster abc88", a[i.toCluster]), l = ot(i.points, a[i.toCluster].node), d = !0), i.fromCluster && (t.debug("from cluster abc88", a[i.fromCluster]), l = ot(l.reverse(), a[i.fromCluster].node).reverse(), d = !0);
	let m = l.filter((e) => !Number.isNaN(e.y)), h = te;
	i.curve && (o === "graph" || o === "flowchart") && (h = i.curve);
	let { x: g, y: _ } = ue(i), v = ce().x(g).y(_).curve(h), y;
	switch (i.thickness) {
		case "normal":
	...
	(u().flowchart.arrowMarkerAbsolute || u().state.arrowMarkerAbsolute) && (x = r(!0)), Qe(b, i, x, c, o);
	let S = {};
...
var K = {
	...
	let m;
	m = t.labelType === "markdown" ? P(f, d(M(p), o), {
		useHtmlLabels: c,
	...
	if (i(o)) {
		...
		await fe(e, p), h = e.getBoundingClientRect(), t.attr("width", h.width), t.attr("height", h.height);
	}
...
var Lt = /* @__PURE__ */ e(async (e, r) => {
	...
	class_box: /* @__PURE__ */ e(async (e, t) => {
		...
		return n(y).attr("transform", "translate( " + (-1 * d / 2 + C) + ", " + (-1 * f / 2 + m) + ")"), m += b.height + 4, c.attr("class", "divider").attr("x1", -d / 2 - r).attr("x2", d / 2 + r).attr("y1", -f / 2 - r + 8 + m).attr("y2", -f / 2 - r + 8 + m), m += 8, x.forEach((e) => {
			n(e).attr("transform", "translate( " + -d / 2 + ", " + (-1 * f / 2 + m + 4) + ")");
			let t = e?.getBBox();
			m += (t?.height ?? 0) + 4;
...
function qt(e, t, n = !1) {
	...
	let l = ie(r?.styles ?? []), u = r.label, d = r.size ?? {
		width: 0,
		height: 0,
		x: 0,
		y: 0
...
async function Yt(e, t, n) {
	let r = qt(t, n, !0);
	n.getBlock(r.id).type !== "space" && (await Gt(e, r, { config: o() }), t.intersect = r?.intersect, Kt(r));
}
