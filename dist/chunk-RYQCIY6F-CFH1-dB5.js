...
import { r as n, t as r } from "./graphlib-feYbMzBj.js";
import { r as i, t as a } from "./map-BOKRoGEl.js";
...
var d = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ e(() => {
	...
	for (let t of d.keys()) {
		let n = d.get(t).id, r = e.parent(n);
		r !== t && d.has(r) && !d.get(r).externalConnections && (d.get(t).id = r);
		let i = e.edges().some((e) => e.v === t);
		if (n && d.get(t)?.externalConnections && i && E(e, n, t)) {
	...
	t.debug("Nodes = ", i, n);
	for (let a of i) if (t.debug("Extracting node", a, d, d.has(a) && !d.get(a).externalConnections, !e.parent(a), e.node(a), e.children("D"), " Depth ", n), !d.has(a)) t.debug("Not a cluster", a, n);
	else if (d.get(a)?.clusterData?.explicitDir && e.children(a) && e.children(a).length > 0) {
		...
		d.get(a)?.clusterData?.dir && (i = d.get(a).clusterData.dir, t.warn("Fixing dir", d.get(a).clusterData.dir, i));
		let o = new r({
			multigraph: !0,
			compound: !0
		}).setGraph({
	...
	for (let r of i) {
		let i = e.node(r);
		t.warn(" Now next level", r, i), i?.clusterNode && C(i.graph, n + 1);
	}
	...
	let r = e.children(t) ?? [];
	for (let i of r) {
		if (i === n || h(i, n)) continue;
		let r = b(i, e, t);
		if (r && !E(e, r, t)) return r;
	}
	return null;
}, "findSafeAnchorNode");
//#endregion
