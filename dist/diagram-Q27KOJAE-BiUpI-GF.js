...
import { m as n, p as r } from "./src-BfmkUsMs.js";
import { D as i, H as a, K as o, U as s, a as c, b as l, c as u, f as d, v as f, w as p, y as m } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { t as h } from "./ordinal-CNzaYghg.js";
import { t as g } from "./defaultLocale-TbxLDlcU.js";
import { i as _ } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { t as v } from "./chunk-JWPE2WC7-os5Vwac_.js";
import { t as y } from "./chunk-KBJHAD2P-Dz0ldegv.js";
import { i as b, n as x } from "./chunk-W5SLKNZC-Bs8d-RNY.js";
import { a as S } from "./mermaid.core-CoIgm_7k.js";
...
var J = class {
	...
	addClass(e, t) {
		...
		r && r.forEach((e) => {
			x(e) && (n?.textStyles ? n.textStyles.push(e) : n.textStyles = [e]), n?.styles ? n.styles.push(e) : n.styles = [e];
...
var se = /* @__PURE__ */ t((e, n) => {
	...
	draw: /* @__PURE__ */ t((e, i, a, o) => {
		...
		if (!p) return;
		let _ = f ? 30 : 0, v = S(i), x = c.nodeWidth ? c.nodeWidth * Q : 960, C = c.nodeHeight ? c.nodeHeight * Q : 500, w = x, T = C + _;
		...
		let A = v.append("g").attr("transform", `translate(0, ${_})`).attr("class", "treemapContainer"), j = R(p).sum((e) => e.value ?? 0).sort((e, t) => (t.value ?? 0) - (e.value ?? 0)), M = oe().size([x, C]).paddingTop((e) => e.children && e.children.length > 0 ? $ + Q : 0).paddingInner(d).paddingLeft((e) => e.children && e.children.length > 0 ? Q : 0).paddingRight((e) => e.children && e.children.length > 0 ? Q : 0).paddingBottom((e) => e.children && e.children.length > 0 ? Q : 0).round(!0)(j), N = M.descendants().filter((e) => e.children && e.children.length > 0), P = A.selectAll(".treemapSection").data(N).enter().append("g").attr("class", "treemapSection").attr("transform", (e) => `translate(${e.x0},${e.y0})`);
		...
		G.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", "treemapLeaf").attr("fill", (e) => e.parent ? D(e.parent.data.name) : D(e.data.name)).attr("style", (e) => b({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles).attr("fill-opacity", .3).attr("stroke", (e) => e.parent ? D(e.parent.data.name) : D(e.data.name)).attr("stroke-width", 3), G.append("clipPath").attr("id", (e, t) => `clip-${i}-${t}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 4)).attr("height", (e) => Math.max(0, e.y1 - e.y0 - 4)), G.append("text").attr("class", "treemapLabel").attr("x", (e) => (e.x1 - e.x0) / 2).attr("y", (e) => (e.y1 - e.y0) / 2).attr("style", (e) => `text-anchor: middle; dominant-baseline: middle; font-size: ${L}px;fill:` + k(e.data.name) + ";" + b({ cssCompiledStyles: e.data.cssCompiledStyles }).labelStyles.replace("color:", "fill:")).attr("clip-path", (e, t) => `url(#clip-${i}-${t})`).text((e) => e.data.name).each(function(e) {
			...
			return (e.y1 - e.y0) / 2;
		}).attr("style", (e) => `text-anchor: middle; dominant-baseline: hanging; font-size: ${z}px;fill:` + k(e.data.name) + ";" + b({ cssCompiledStyles: e.data.cssCompiledStyles }).labelStyles.replace("color:", "fill:")).attr("clip-path", (e, t) => `url(#clip-${i}-${t})`).text((e) => e.value ? E(e.value) : "").each(function(e) {
		...
		y(v, K, "flowchart", c?.useMaxWidth || !1);
	}, "draw"),
