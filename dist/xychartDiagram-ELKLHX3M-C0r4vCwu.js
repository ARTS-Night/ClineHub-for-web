...
import { D as n, H as r, K as i, U as a, a as o, b as s, c, f as l, v as u, w as d, y as f, z as p } from "./chunk-I66GZJ75-DaJZKFkN.js";
import { t as m } from "./linear-L0rVVt6x.js";
import { t as h } from "./ordinal-CNzaYghg.js";
import { t as g } from "./init-Cgg2UTSf.js";
import { i as _ } from "./chunk-NSK5VX7P-pGKppjHe.js";
import { t as v } from "./line-B4kwC9Sr.js";
import "./chunk-4I5QYGJK-_sTbXS-x.js";
import { t as y } from "./chunk-WRU74C26-2tQNDD2Y.js";
import { a as b } from "./mermaid.core-CoIgm_7k.js";
...
e(U, "getChartDefaultThemeConfig");
function W() {
	let e = s();
	return _(l.xyChart, e.xyChart);
}
e(W, "getChartDefaultConfig");
function G() {
	return {
		yAxis: {
			type: "linear",
...
e(de, "setYAxisRangeFromPlotData");
function Z(e) {
	let t = [];
	...
	if (E(z.xAxis) && e.length > z.xAxis.categories.length && (e = e.slice(0, z.xAxis.categories.length)), H || de(e), E(z.xAxis) && (t = z.xAxis.categories.map((t, n) => [t, e[n]])), D(z.xAxis)) {
		let n = z.xAxis.min, r = z.xAxis.max;
...
function fe(e, t) {
	let n = t.map((e) => e.value), r = t.map((e) => e.label ? K(e.label) : ""), i = Z(n), a = r.some((e) => e !== "");
	z.plots.push({
		type: "line",
		strokeFill: Q(F),
		strokeWidth: 2,
...
function me() {
	...
	return z.title = d(), se.build(L, z, R, I);
}
e(me, "getDrawableElem");
function he() {
	return R;
}
e(he, "getChartThemeConfig");
function ge() {
	return L;
}
e(ge, "getChartConfig");
...
var _e = {
	...
	db: {
		...
		clear: /* @__PURE__ */ e(function() {
			o(), F = 0, L = W(), z = G(), R = U(), B = R.plotColorPalette.split(",").map((e) => e.trim()), V = !1, H = !1;
		}, "clear"),
		setAccTitle: a,
		getAccTitle: f,
		setDiagramTitle: i,
